...
} from "./chunk-TYNYMZIA.js";
import {
  ListSymbol,
  RAFLoop,
  TimeRange
} from "./chunk-6Y7L6EDI.js";
import {
  DOMEvent,
  createScope,
  effect,
  ...
  peek,
  untrack
} from "./chunk-D6BBBS25.js";
import "./chunk-ANQ5YHZ7.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
// node_modules/@vidstack/react/dev/chunks/vidstack-CQvgL2Oa.js
var _info, _GoogleCastMediaInfoBuilder_instances, buildCastTrack_fn, _a;
var GoogleCastMediaInfoBuilder = (_a = class {
  constructor(src) {
  ...
  setStreamType(streamType) {
    if (streamType.includes("live")) __privateGet(this, _info).streamType = chrome.cast.media.StreamType.LIVE;
    else __privateGet(this, _info).streamType = chrome.cast.media.StreamType.BUFFERED;
    return this;
  }
  setTracks(tracks) {
...
}, _info = new WeakMap(), _GoogleCastMediaInfoBuilder_instances = new WeakSet(), buildCastTrack_fn = function(track, trackId) {
...
var _cast, _ctx, _onNewLocalTracks, _GoogleCastTracksManager_instances, getLocalAudioTracks_fn, getRemoteTracks_fn, getRemoteActiveIds_fn, syncLocalTracks_fn, editTracksInfo_fn, findLocalTrack_fn, findRemoteTrack_fn, isMatch_fn, _a2;
var GoogleCastTracksManager = (_a2 = class {
  ...
  syncRemoteTracks(event) {
    ...
    for (const remoteAudioTrack of remoteAudioTracks) {
      if (__privateMethod(this, _GoogleCastTracksManager_instances, findLocalTrack_fn).call(this, localAudioTracks, remoteAudioTrack)) continue;
    ...
    for (const remoteTextTrack of remoteTextTracks) {
      if (__privateMethod(this, _GoogleCastTracksManager_instances, findLocalTrack_fn).call(this, localTextTracks, remoteTextTrack)) continue;
  ...
  syncRemoteActiveIds(event) {
    ...
    __privateMethod(this, _GoogleCastTracksManager_instances, editTracksInfo_fn).call(this, editRequest).catch((error) => {
      var _a4;
      (_a4 = __privateGet(this, _ctx).logger) == null ? void 0 : _a4.errorGroup("[vidstack] failed to edit cast tracks info").labelledLog("Edit Request", editRequest).labelledLog("Error", error).dispatch();
    });
  }
}, _cast = new WeakMap(), _ctx = new WeakMap(), _onNewLocalTracks = new WeakMap(), _GoogleCastTracksManager_instances = new WeakSet(), getLocalAudioTracks_fn = function() {
  return __privateGet(this, _ctx).$state.audioTracks();
}, getRemoteTracks_fn = function(type) {
  var _a4;
  const tracks = ((_a4 = __privateGet(this, _cast).mediaInfo) == null ? void 0 : _a4.tracks) ?? [];
  ...
  for (const localTrack of localTextTracks) if (!__privateMethod(this, _GoogleCastTracksManager_instances, findRemoteTrack_fn).call(this, remoteTextTracks, localTrack)) {
    untrack(() => {
      var _a4;
      return (_a4 = __privateGet(this, _onNewLocalTracks)) == null ? void 0 : _a4.call(this);
    });
    break;
  }
...
var GoogleCastProvider = (_a3 = class {
  ...
  */
  ...
  async play() {
    ...
    (_a4 = __privateGet(this, _player).controller) == null ? void 0 : _a4.playOrPause();
  }
  async pause() {
    var _a4;
  ...
  getMediaStatus(request) {
    return new Promise((resolve, reject) => {
      var _a4;
      (_a4 = this.media) == null ? void 0 : _a4.getStatus(request, resolve, reject);
    });
  }
  setMuted(muted) {
    var _a4;
    if (muted && !__privateGet(this, _player).isMuted || !muted && __privateGet(this, _player).isMuted) (_a4 = __privateGet(this, _player).controller) == null ? void 0 : _a4.muteOrUnmute();
  }
  setCurrentTime(time) {
    var _a4;
    __privateGet(this, _player).currentTime = time;
    __privateGet(this, _ctx2).notify("seeking", time);
    (_a4 = __privateGet(this, _player).controller) == null ? void 0 : _a4.seek();
  }
  setVolume(volume) {
    var _a4;
    __privateGet(this, _player).volumeLevel = volume;
    (_a4 = __privateGet(this, _player).controller) == null ? void 0 : _a4.setVolumeLevel();
  }
  async loadSource(src) {
    var _a4;
    if (((_a4 = __privateGet(this, _reloadInfo)) == null ? void 0 : _a4.src) !== src) __privateSet(this, _reloadInfo, null);
...
}, _player = new WeakMap(), _ctx2 = new WeakMap(), _tracks = new WeakMap(), _currentSrc = new WeakMap(), _state = new WeakMap(), _currentTime = new WeakMap(), _played = new WeakMap(), _seekableRange = new WeakMap(), _timeRAF = new WeakMap(), _playerEventHandlers = new WeakMap(), _reloadInfo = new WeakMap(), _isIdle = new WeakMap(), _GoogleCastProvider_instances = new WeakSet(), attachCastContextEventListeners_fn = function() {
  listenCastContextEvent(cast.framework.CastContextEventType.CAST_STATE_CHANGED, __privateMethod(this, _GoogleCastProvider_instances, onCastStateChange_fn).bind(this));
  ...
  for (const type of keysOf(handlers)) __privateGet(this, _player).controller.addEventListener(type, handler);
  onDispose(() => {
    for (const type of keysOf(handlers)) __privateGet(this, _player).controller.removeEventListener(type, handler);
  });
}, reset_fn = function() {
  ...
  const detail = {
    type: "google-cast",
    state
  }, trigger = __privateMethod(this, _GoogleCastProvider_instances, createEvent_fn).call(this, data);
  __privateSet(this, _state, state);
  __privateGet(this, _ctx2).notify("remote-playback-change", detail, trigger);
  if (state === "disconnected") __privateMethod(this, _GoogleCastProvider_instances, disconnectFromReceiver_fn).call(this);
  ...
  var _a4;
  return ((_a4 = __privateGet(this, _player).mediaInfo) == null ? void 0 : _a4.streamType) === chrome.cast.media.StreamType.LIVE ? __privateGet(this, _player).canSeek ? "live:dvr" : "live" : "on-demand";
  ...
  if (__privateGet(this, _ctx2).$state.seeking()) __privateGet(this, _ctx2).notify("seeked", currentTime);
  ...
  const trigger = __privateMethod(this, _GoogleCastProvider_instances, createEvent_fn).call(this, event);
  if (__privateGet(this, _player).isPaused) __privateGet(this, _ctx2).notify("pause", void 0, trigger);
  else __privateGet(this, _ctx2).notify("play", void 0, trigger);
  ...
  request.autoplay = (((_a4 = __privateGet(this, _reloadInfo)) == null ? void 0 : _a4.paused) ?? (savedState == null ? void 0 : savedState.paused)) === false;
  ...
  __privateMethod(this, _GoogleCastProvider_instances, reload_fn).call(this, __privateGet(this, _player).isPaused, __privateGet(this, _player).currentTime).catch((error) => {
    var _a4;
    (_a4 = __privateGet(this, _ctx2).logger) == null ? void 0 : _a4.errorGroup("[vidstack] cast failed to load new local tracks").labelledLog("Error", error).dispatch();
  });
}, _a3);
export {
  GoogleCastProvider
};
//# sourceMappingURL=vidstack-CQvgL2Oa-UHQ3AIIH.js.map
