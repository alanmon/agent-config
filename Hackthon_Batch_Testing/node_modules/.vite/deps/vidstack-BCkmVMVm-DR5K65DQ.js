...
import {
  EmbedProvider
} from "./chunk-5NCRSF5M.js";
import {
  getVimeoVideoInfo,
  resolveVimeoVideoId
} from "./chunk-HRHQKREC.js";
import {
  ListSymbol,
  QualitySymbol,
  RAFLoop,
...
// node_modules/@vidstack/react/dev/chunks/vidstack-BCkmVMVm.js
...
var VimeoProvider = (_a = class extends EmbedProvider {
...
}, _ctx = new WeakMap(), _videoId = new WeakMap(), _pro = new WeakMap(), _hash = new WeakMap(), _currentSrc = new WeakMap(), _fullscreenActive = new WeakMap(), _seekableRange = new WeakMap(), _timeRAF = new WeakMap(), _currentCue = new WeakMap(), _chaptersTrack = new WeakMap(), _promises = new WeakMap(), _videoInfoPromise = new WeakMap(), _VimeoProvider_instances = new WeakSet(), watchVideoId_fn = function() {
  __privateMethod(this, _VimeoProvider_instances, reset_fn).call(this);
  ...
  getVimeoVideoInfo(videoId, abort, __privateGet(this, _hash)).then((info) => {
    ...
    var _a2;
    promise.reject();
    (_a2 = __privateGet(this, _ctx).logger) == null ? void 0 : _a2.warnGroup(`Failed to fetch vimeo video info for id \`${videoId}\`.`).labelledLog("Error", e).dispatch();
  });
  return () => {
    promise.reject();
    abort.abort();
  ...
  if (isPro) return listenEvent(qualities, "change", () => {
    var _a2;
    if (qualities.auto) return;
    const id = (_a2 = qualities.selected) == null ? void 0 : _a2.id;
...
}, _preventTimeUpdates = new WeakMap(), onTimeUpdate_fn = function(time, trigger) {
  ...
  if (Math.abs(prevTime - time) > 1.5) {
    ...
    if (!paused() && bufferedEnd() < time) __privateGet(this, _ctx).notify("waiting", void 0, trigger);
  }
  ...
  var _a2;
  const videoId = __privateGet(this, _videoId).call(this);
  (_a2 = __privateGet(this, _videoInfoPromise)) == null ? void 0 : _a2.promise.then((info) => {
    if (!info) return;
  ...
  if (!showEmbedControls) __privateMethod(this, _VimeoProvider_instances, remote_fn).call(this, "_hideOverlay");
  ...
  switch (method) {
    ...
    case "getDuration":
      const duration = data;
      if (!__privateGet(this, _ctx).$state.canPlay()) __privateMethod(this, _VimeoProvider_instances, onReady_fn).call(this, duration, trigger);
      else __privateGet(this, _ctx).notify("duration-change", duration, trigger);
      break;
    case "getCurrentTime":
      __privateMethod(this, _VimeoProvider_instances, onTimeUpdate_fn).call(this, data, trigger);
      break;
    case "getBuffered":
      if (isArray(data) && data.length) __privateMethod(this, _VimeoProvider_instances, onLoadProgress_fn).call(this, data[data.length - 1][1], trigger);
      break;
    case "setMuted":
    case "getMuted":
  ...
  (_a2 = __privateMethod(this, _VimeoProvider_instances, getPromise_fn).call(this, method)) == null ? void 0 : _a2.resolve();
}, attachListeners_fn = function() {
  for (const type of trackedVimeoEvents) __privateMethod(this, _VimeoProvider_instances, remote_fn).call(this, "addEventListener", type);
}, onPause_fn = function(trigger) {
  __privateGet(this, _timeRAF).stop();
  __privateGet(this, _ctx).notify("pause", void 0, trigger);
}, onPlay_fn = async function(trigger) {
  __privateGet(this, _timeRAF).start();
  await __privateMethod(this, _VimeoProvider_instances, remote_fn).call(this, "getMuted");
  ...
  if (!paused() && !__privateGet(this, _preventTimeUpdates)) __privateGet(this, _ctx).notify("playing", void 0, trigger);
...
}, onWaiting_fn = async function(trigger) {
  const { paused } = __privateGet(this, _ctx).$state;
  if (paused()) {
    await __privateMethod(this, _VimeoProvider_instances, remote_fn).call(this, "getMuted");
    __privateGet(this, _ctx).notify("play", void 0, trigger);
  ...
  for (let i = 0; i < chapters.length; i++) {
    ...
    track.addCue(new window.VTTCue(chapter.startTime, (nextChapter == null ? void 0 : nextChapter.startTime) ?? seekableEnd(), chapter.title));
  }
  ...
  } else __privateGet(this, _ctx).qualities[ListSymbol.select](newQuality ?? void 0, true, trigger);
  ...
  if (method === "setPlaybackRate") __privateGet(this, _pro).set(false);
  if (method) (_a2 = __privateMethod(this, _VimeoProvider_instances, getPromise_fn).call(this, method)) == null ? void 0 : _a2.reject(message);
  ...
  var _a2;
  return (_a2 = __privateGet(this, _promises).get(command)) == null ? void 0 : _a2.shift();
}, _a);
export {
  VimeoProvider
};
//# sourceMappingURL=vidstack-BCkmVMVm-DR5K65DQ.js.map
