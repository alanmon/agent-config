...
// node_modules/@vidstack/react/dev/chunks/vidstack-Ck_kOQuM.js
var _player, _GoogleCastLoader_instances, loadCastFramework_fn, showPrompt_fn, setOptions_fn, notifyRemoteStateChange_fn, createError_fn, _a;
var GoogleCastLoader = (_a = class {
  constructor() {
  ...
  */
  ...
  async prompt(ctx) {
    ...
    try {
      ...
      openEvent = ctx.player.createEvent("google-cast-prompt-open", { trigger: loadEvent });
      ...
      ctx.$state.remotePlaybackInfo.set({ deviceName: (_a2 = getCastSession()) == null ? void 0 : _a2.getCastDevice().friendlyName });
      ...
      ctx.player.dispatch("google-cast-prompt-close", { trigger: errorEvent ?? openEvent ?? loadEvent });
    }
  }
  async load(ctx) {
    if (IS_SERVER) throw Error("[vidstack] can not load google cast provider server-side");
    if (!__privateGet(this, _player)) throw Error("[vidstack] google cast player was not initialized");
    return new (await import("./vidstack-CQvgL2Oa-UHQ3AIIH.js")).GoogleCastProvider(__privateGet(this, _player), ctx);
  }
}, _player = new WeakMap(), _GoogleCastLoader_instances = new WeakSet(), loadCastFramework_fn = async function(ctx) {
  ...
  if (!isCastAvailable()) throw __privateMethod(this, _GoogleCastLoader_instances, createError_fn).call(this, "CAST_NOT_AVAILABLE", "Google Cast not available on this platform.");
  return loadedEvent;
  ...
  if (errorCode) throw __privateMethod(this, _GoogleCastLoader_instances, createError_fn).call(this, errorCode.toUpperCase(), getCastErrorMessage(errorCode));
}, setOptions_fn = function(options) {
  var _a2;
  (_a2 = this.cast) == null ? void 0 : _a2.setOptions({
    ...getDefaultCastOptions(),
    ...options
  });
...
//# sourceMappingURL=vidstack-Ck_kOQuM-PR6BFZB4.js.map
