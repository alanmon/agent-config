...
// node_modules/@vidstack/react/dev/chunks/vidstack-D1HTiCgh.js
var _iframe, _EmbedProvider_instances, watchSrc_fn, onWindowMessage_fn, _a;
var EmbedProvider = (_a = class {
  constructor(iframe) {
    ...
    */
    ...
    if (this.referrerPolicy !== null) iframe.setAttribute("referrerpolicy", this.referrerPolicy);
  }
  get iframe() {
  ...
  postMessage(message, target) {
    var _a2;
    if (IS_SERVER) return;
    (_a2 = __privateGet(this, _iframe).contentWindow) == null ? void 0 : _a2.postMessage(JSON.stringify(message), target ?? "*");
  }
  ...
  if (!((event.source === null || event.source === ((_a2 = __privateGet(this, _iframe)) == null ? void 0 : _a2.contentWindow)) && (!isString(origin) || origin === event.origin))) return;
  try {
...
//# sourceMappingURL=chunk-5NCRSF5M.js.map
