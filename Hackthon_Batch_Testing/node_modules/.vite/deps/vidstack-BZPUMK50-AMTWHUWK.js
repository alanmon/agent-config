...
// node_modules/@vidstack/react/dev/chunks/vidstack-BZPUMK50.js
...
var _ctx, _videoId, _state, _currentSrc, _seekingTimer, _invalidPlay, _promises, _YouTubeProvider_instances, playFail_fn, pauseFail_fn, watchVideoId_fn, remote_fn, onReady_fn, onPause_fn, onTimeUpdate_fn, onProgress_fn, onSeeked_fn, onEnded_fn, onStateChange_fn, reset_fn, getPromise_fn, isPending_fn, _a;
var YouTubeProvider = (_a = class extends EmbedProvider {
  ...
  setCurrentTime(time) {
    __privateMethod(this, _YouTubeProvider_instances, remote_fn).call(this, "seekTo", [time, true]);
  ...
  onMessage({ info }, event) {
    ...
    if (isObject(info.videoData) && info.videoData.title !== title()) __privateGet(this, _ctx).notify("title-change", info.videoData.title, event);
    if (isNumber(info.duration) && info.duration !== intrinsicDuration()) {
      if (isNumber(info.videoLoadedFraction)) {
        const buffered = ((_a2 = info.progressState) == null ? void 0 : _a2.loaded) ?? info.videoLoadedFraction * info.duration, seekable = new TimeRange(0, info.duration);
    ...
    if (isNumber(info.playbackRate) && info.playbackRate !== playbackRate()) __privateGet(this, _ctx).notify("rate-change", info.playbackRate, event);
    if (info.progressState) {
      ...
      if (duration !== intrinsicDuration()) __privateGet(this, _ctx).notify("duration-change", duration, event);
    }
    ...
    if (isNumber(info.playerState) && info.playerState !== __privateGet(this, _state)) __privateMethod(this, _YouTubeProvider_instances, onStateChange_fn).call(this, info.playerState, event);
  }
}, _ctx = new WeakMap(), _videoId = new WeakMap(), _state = new WeakMap(), _currentSrc = new WeakMap(), _seekingTimer = new WeakMap(), _invalidPlay = new WeakMap(), _promises = new WeakMap(), _YouTubeProvider_instances = new WeakSet(), playFail_fn = function(message) {
  var _a2;
  (_a2 = __privateMethod(this, _YouTubeProvider_instances, getPromise_fn).call(this, "playVideo")) == null ? void 0 : _a2.reject(message);
}, pauseFail_fn = function(message) {
  var _a2;
  (_a2 = __privateMethod(this, _YouTubeProvider_instances, getPromise_fn).call(this, "pauseVideo")) == null ? void 0 : _a2.reject(message);
  ...
  var _a2;
  (_a2 = __privateMethod(this, _YouTubeProvider_instances, getPromise_fn).call(this, "pauseVideo")) == null ? void 0 : _a2.resolve();
  ...
  if (!hasEnded && Math.abs(boundTime - realCurrentTime()) > 1) __privateGet(this, _ctx).notify("seeking", boundTime, trigger);
  ...
  if (seeking() && buffered > realCurrentTime()) __privateMethod(this, _YouTubeProvider_instances, onSeeked_fn).call(this, trigger);
  ...
  if (seeking() && isPlaying) __privateMethod(this, _YouTubeProvider_instances, onSeeked_fn).call(this, trigger);
  ...
  if (isPlay) {
    (_a2 = __privateMethod(this, _YouTubeProvider_instances, getPromise_fn).call(this, "playVideo")) == null ? void 0 : _a2.resolve();
  ...
  var _a2;
  return Boolean((_a2 = __privateGet(this, _promises).get(command)) == null ? void 0 : _a2.length);
}, _a);
export {
  YouTubeProvider
};
//# sourceMappingURL=vidstack-BZPUMK50-AMTWHUWK.js.map
