...
import {
  ...
  __privateSet,
  __toESM
} from "./chunk-SS7IICYN.js";

// node_modules/@vidstack/react/dev/chunks/vidstack-BLEs9rMG.js
...
// node_modules/@vidstack/react/dev/chunks/vidstack-CWZPUheZ.js
...
function computed(compute2, options) {
  const node = createComputation(options == null ? void 0 : options.initial, compute2, options), signal2 = read.bind(node);
  signal2[SCOPE] = true;
  return signal2;
}
...
var DOMEvent = class extends EVENT {
  ...
  */
  get isOriginTrusted() {
    var _a5;
    return ((_a5 = this.triggers.origin) == null ? void 0 : _a5.isTrusted) ?? false;
  }
  constructor(type, ...init) {
    ...
    this.detail = (_a5 = init[0]) == null ? void 0 : _a5.detail;
...
var _target, _controller, _a;
var EventsController = (_a = class {
  constructor(target) {
...
function provideContext(context, value, scope = getScope()) {
  ...
  setContext(context.id, hasProvidedValue ? value : (_a5 = context.provide) == null ? void 0 : _a5.call(context), scope);
}
...
var EMPTY_PROPS = {};
var _setupCallbacks, _attachCallbacks, _connectCallbacks, _destroyCallbacks, _Instance_instances, attachAttrs_fn, attachStyles_fn, setAttr_fn, setStyle_fn, _a2;
var Instance = (_a2 = class {
  constructor(Component3, scope, init) {
    ...
    this.attrs = null;
    this.styles = null;
    __privateSet(this, _setupCallbacks, []);
    __privateSet(this, _attachCallbacks, []);
    __privateSet(this, _connectCallbacks, []);
    __privateSet(this, _destroyCallbacks, []);
    this.scope = scope;
    ...
    if (stateFactory) {
      ...
      this.state = new Proxy(this.$state, { get: (_, prop2) => this.$state[prop2]() });
      provideContext(stateFactory, this.$state);
    }
    if (props) {
      this.props = createInstanceProps(props);
      if (init == null ? void 0 : init.props) for (const prop2 of Object.keys(init.props)) (_a5 = this.props[prop2]) == null ? void 0 : _a5.set(init.props[prop2]);
    }
  ...
  attach(el) {
    ...
    this.el = el;
    this.$el.set(el);
    el.$$COMPONENT_NAME = (_a5 = this.component) == null ? void 0 : _a5.constructor.name;
    scoped(() => {
  ...
  detach() {
    var _a5;
    (_a5 = this.attachScope) == null ? void 0 : _a5.dispose();
    this.attachScope = null;
    this.connectScope = null;
  ...
  disconnect() {
    var _a5;
    (_a5 = this.connectScope) == null ? void 0 : _a5.dispose();
    this.connectScope = null;
  }
  destroy() {
...
}, _setupCallbacks = new WeakMap(), _attachCallbacks = new WeakMap(), _connectCallbacks = new WeakMap(), _destroyCallbacks = new WeakMap(), _Instance_instances = new WeakSet(), attachAttrs_fn = function() {
  if (!this.attrs) return;
  for (const name of Object.keys(this.attrs)) if (isFunction(this.attrs[name])) effect(__privateMethod(this, _Instance_instances, setAttr_fn).bind(this, name));
  else setAttribute(this.el, name, this.attrs[name]);
}, attachStyles_fn = function() {
  if (!this.styles) return;
  for (const name of Object.keys(this.styles)) if (isFunction(this.styles[name])) effect(__privateMethod(this, _Instance_instances, setStyle_fn).bind(this, name));
...
var ViewController = class extends EventTarget {
  ...
  removeEventListener(type, callback, options) {
    var _a5;
    (_a5 = this.el) == null ? void 0 : _a5.removeEventListener(type, callback, options);
  }
  /**
  ...
  */
  dispatch(type, ...init) {
    ...
    return untrack(() => {
      var _a5, _b;
      (_b = (_a5 = this.$$)[ON_DISPATCH]) == null ? void 0 : _b.call(_a5, event);
...
var _a4, _context, _provide, _scope;
_a4 = class extends React.Component {
  constructor(props, context) {
    ...
    if (__privateGet(Ctor, _context)) provideContext(__privateGet(Ctor, _context), (_a5 = __privateGet(Ctor, _provide)) == null ? void 0 : _a5.call(Ctor), __privateGet(this, _scope).current);
  }
  componentWillUnmount() {
    var _a5;
    (_a5 = __privateGet(this, _scope).current) == null ? void 0 : _a5.dispose();
    __privateGet(this, _scope).current = null;
  }
  render() {
    var _a5;
    return WithScope(__privateGet(this, _scope), (_a5 = this.props) == null ? void 0 : _a5.children);
  }
  ...
  const forwardComponent = React.forwardRef((props, forwardRef2) => {
    ...
    function onAttach() {
      ...
      if (state2.component.$$.destroyed) {
        const component = initComponent(Component3, state2, props, scope);
        state2.component = component;
    ...
    function onRefChange(el) {
      ...
      clearTimeout(state2.refChangeId);
      state2.refChangeId = window.setTimeout(() => {
    ...
    React.useEffect(() => {
      ...
      return function onDestroy() {
        ...
        clearTimeout(state2.connectId);
        state2.connectId = -1;
        clearTimeout(state2.destroyId);
        state2.destroyId = window.setTimeout(() => {
          state2.destroyId = -1;
    ...
    state.callbacks = {};
    for (const name of [...prevPropNames, ...newPropNames]) if (options.props.has(name)) state.component.$props[name].set(isUndefined(renderProps[name]) ? (_a5 = Component3.props) == null ? void 0 : _a5[name] : renderProps[name]);
    else if (((_b = options.events) == null ? void 0 : _b.has(name)) || ((_c = options.eventsRE) == null ? void 0 : _c.test(name))) state.callbacks[name] = renderProps[name];
    ...
    return WithScope(scopeRef, React.createElement(AttachEffect, { effect: onAttach }), isFunction(children) ? children == null ? void 0 : children({
      ...attrs,
      suppressHydrationWarning: true,
      ref: onRefChange
    }, state.component) : children);
  });
  forwardComponent.displayName = Component3.name + "Bridge";
...
function createInternalState() {
  const state = {
    ...
    onDOMEvent(event) {
      ...
      (_b = (_a5 = state.domCallbacks)[event.type]) == null ? void 0 : _b.call(_a5, ...args);
    }
  };
  return state;
}
...
function onDispatch(event) {
  ...
  (_b = (_a5 = this.callbacks)[callbackProp]) == null ? void 0 : _b.call(_a5, ...args);
}
function initComponent(Component3, state, props, scope) {
  const component = createComponent(Component3, {
    props,
    scope
  });
...
var chromecast_exports = __exportAll({ default: () => Icon$24 });
...
//# sourceMappingURL=chunk-D6BBBS25.js.map
