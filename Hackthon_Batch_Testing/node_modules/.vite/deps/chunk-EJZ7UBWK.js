...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./srt-parser-V7SN53ON.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./ssa-parser-JEWKPZGU.js")).default;
        break;
      default:
...
var VTTParser = class {
  ...
  async init(init) {
    ...
    if (init.strict)
      this._block = 1;
    if (init.errors)
      this._errorBuilder = (await import("./errors-2LAY33JZ.js")).ParseErrorBuilder;
  }
...
//# sourceMappingURL=chunk-EJZ7UBWK.js.map
