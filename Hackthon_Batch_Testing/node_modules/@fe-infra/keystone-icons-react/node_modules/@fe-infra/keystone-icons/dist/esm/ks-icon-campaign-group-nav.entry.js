...
const KsIconCampaignGroupNav = class {
    constructor(hostRef) {
...
KsIconCampaignGroupNav.style = indexCss;

export { KsIconCampaignGroupNav as ks_icon_campaign_group_nav };
//# sourceMappingURL=ks-icon-campaign-group-nav.entry.js.map
