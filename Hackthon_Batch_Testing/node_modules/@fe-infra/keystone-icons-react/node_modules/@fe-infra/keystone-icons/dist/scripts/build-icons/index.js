...
import { getComponentTagName, getComponentClassName, getComponentHostClassName, getComponentProps, getComponentEvents, getComponentElement, getComponentStyleUrls, } from "./generate-component";
...
const buildIconComponent = async (iconFileName) => {
    ...
    const formattedComponent = await formatCode(filePath, component);
...
(async function () {
    ...
    const promises = fs
        ...
        .map((fileName) => new Promise(async (resolve) => {
        try {
