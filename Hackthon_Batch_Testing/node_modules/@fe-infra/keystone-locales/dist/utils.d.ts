 ...
 */
export declare function resolveMessage<T extends LocalizedMessage<Record<string, string | number> | never>>(locale: Locale, defaultLocale: Locale, localizedMessage: T, ...maybeInterpolation: T['__interpolation'] extends never ? [] : [T['__interpolation']]): string;
export declare function isSupportedLocale(maybeLocale: unknown): maybeLocale is Locale;
