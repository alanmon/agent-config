...
import { Column, OnChangeFn, Table, Updater, RowData, TableFeature } from '../types';
...
export const GlobalFiltering: TableFeature = {
  ...
  getDefaultOptions: <TData extends RowData>(table: Table<TData>): GlobalFilterOptions<TData> =>
    ({
    ...
    table.getGlobalFilterFn = () => {
      ...
      return isFunction(globalFilterFn)
        ...
        : globalFilterFn === 'auto'
          ...
          : (table.options.filterFns?.[globalFilterFn as string] ?? filterFns[globalFilterFn as BuiltInFilterFn]);
    };
