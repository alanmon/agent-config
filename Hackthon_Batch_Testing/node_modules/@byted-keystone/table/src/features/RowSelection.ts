...
export const RowSelection: TableFeature = {
  ...
  getDefaultOptions: <TData extends RowData>(table: Table<TData>): RowSelectionOptions<TData> => ({
  ...
  createTable: <TData extends RowData>(table: Table<TData>): void => {
    ...
    table.getToggleAllRowsSelectedHandler = () => (e: unknown) => {
      table.toggleAllRowsSelected(((e as MouseEvent).target as HTMLInputElement).checked);
    };

    table.getToggleAllPageRowsSelectedHandler = () => (e: unknown) => {
      table.toggleAllPageRowsSelected(((e as MouseEvent).target as HTMLInputElement).checked);
    };
  },
};

export const mutateRowIsSelected = <TData extends RowData>(
...
export function selectRowsFn<TData extends RowData>(table: Table<TData>, rowModel: RowModel<TData>): RowModel<TData> {
...
export function isRowSelected<TData extends RowData>(row: Row<TData>, selection: Record<string, boolean>): boolean {
