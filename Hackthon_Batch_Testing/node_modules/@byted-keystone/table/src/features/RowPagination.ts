...
export const RowPagination: TableFeature = {
  ...
  getDefaultOptions: <TData extends RowData>(table: Table<TData>): PaginationDefaultOptions => ({
  ...
  createTable: <TData extends RowData>(table: Table<TData>): void => {
    ...
    table.getPageCount = () =>
      table.options.pageCount ?? Math.ceil(table.getRowCount() / table.getState().pagination.pageSize);
