...
import { Column, OnChangeFn, Table, Row, Updater, RowData, SortingFns, TableFeature } from '../types';
...
export const RowSorting: TableFeature = {
  ...
  getDefaultOptions: <TData extends RowData>(table: Table<TData>): SortingOptions<TData> => ({
