...
export const ColumnVisibility: TableFeature = {
  ...
  getDefaultOptions: <TData extends RowData>(table: Table<TData>): VisibilityDefaultOptions => ({
  ...
  createTable: <TData extends RowData>(table: Table<TData>): void => {
    ...
    table.getToggleAllColumnsVisibilityHandler = () => (e: unknown) => {
      table.toggleAllColumnsVisible(((e as MouseEvent).target as HTMLInputElement)?.checked);
    };
  },
};
