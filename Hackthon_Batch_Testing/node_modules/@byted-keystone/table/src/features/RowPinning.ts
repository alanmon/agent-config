import { OnChangeFn, Updater, Table, Row, RowData, TableFeature } from '../types';
...
export const RowPinning: TableFeature = {
  ...
  getDefaultOptions: <TData extends RowData>(table: Table<TData>): RowPinningDefaultOptions => ({
