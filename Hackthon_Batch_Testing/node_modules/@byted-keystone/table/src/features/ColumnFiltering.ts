...
export const ColumnFiltering: TableFeature = {
  getDefaultColumnDef: <TData extends RowData>(): ColumnFiltersColumnDef<TData> => ({
    filterFn: 'auto',
  }),
  ...
  getDefaultOptions: <TData extends RowData>(table: Table<TData>): ColumnFiltersOptions<TData> =>
    ({
  ...
  createRow: <TData extends RowData>(row: Row<TData>, _table: Table<TData>): void => {
    row.columnFilters = {};
  ...
  createTable: <TData extends RowData>(table: Table<TData>): void => {
    table.setColumnFilters = (updater: Updater<ColumnFiltersState>) => {
      ...
      const updateFn = (old: ColumnFiltersState) =>
        functionalUpdate(updater, old)?.filter((filter) => {
