...
import { RowSelectionRow } from '../features/RowSelection';
import { RowData, Cell, Table, FilterMeta } from '../types';
import { ExpandedRow } from '../features/RowExpanding';
...
export declare class Row<TData extends RowData> extends Memo implements CoreRow<TData>, VisibilityRow<TData>, ColumnPinningRow<TData>, RowPinningRow, ColumnFiltersRow<TData>, GroupingRow, RowSelectionRow, ExpandedRow {
    static VALUE_CACHE: boolean;
    static CELL_CACHE: boolean;
    static cache({ value, cell }: {
    ...
    subRows: Row<TData>[];
    constructor(table: Table<TData>, id: string, original: TData, rowIndex: number, depth: number, subRows?: Row<TData>[], parentId?: string);
    clone(): Row<TData>;
    getValue<TValue>(columnId: string): TValue;
    getUniqueValues<TValue>(columnId: string): TValue[];
    renderValue<TValue>(columnId: string): TValue;
