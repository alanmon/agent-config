...
export type Lifecycle = 'connectedCallback' | 'disconnectedCallback' | 'componentWillLoad' | 'componentDidLoad' | 'componentWillRender' | 'componentDidRender' | 'componentWillUpdate' | 'componentDidUpdate' | 'init';
