import { i as pluginManager } from './p-BDWjpCqC.js';

const triggerLifecycleHook = (component, lifecycle) => {
 ...
 * ```
 */
const registerPluginManager = (el) => {
...
export { registerPluginManager as r };
//# sourceMappingURL=p-D1SAjL-M.js.map
