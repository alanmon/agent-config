...
`@fe-infra/keystone-icons-react` provides React wrappers around the Keystone Icons custom element runtime. This package exposes tree-shakeable icon components for React applications.
...
`@fe-infra/keystone-icons-react` is built on top of the Keystone Icons custom element runtime.
