 ...
 */
export declare const reactOutputTarget: ({ outDir, esModules, stencilPackageName, excludeComponents, customElementsDir: customElementsDirOverride, hydrateModule, excludeServerSideRenderingFor, aliasEventNames, tagNameSuffix, }: ReactOutputTargetOptions) => ReactOutputTarget;
export {};
