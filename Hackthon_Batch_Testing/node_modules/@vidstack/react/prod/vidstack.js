...
function MediaOutlet({ provider, mediaProps, iframeProps }) {
	...
	React.useEffect(() => {
		...
		import("./chunks/vidstack-B9fTkxQO.js").then((n) => n.chromecast_exports).then((mod) => {
