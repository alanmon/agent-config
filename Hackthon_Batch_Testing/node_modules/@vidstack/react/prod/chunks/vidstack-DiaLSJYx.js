...
import { DOMEvent, camelToKebabCase, effect, isFunction, isString, isUndefined, listenEvent, peek } from "./vidstack-B9fTkxQO.js";
import { IS_CHROME, ListSymbol, QualitySymbol, RAFLoop, TextTrack, TextTrackSymbol, VideoProvider, coerceToError, isHLSSupported, loadScript, preconnect } from "./vidstack-CvezEmSQ.js";
...
async function loadHLSScript(src, callbacks = {}) {
	...
	try {
		...
		if (!isFunction(window.Hls)) throw Error("");
