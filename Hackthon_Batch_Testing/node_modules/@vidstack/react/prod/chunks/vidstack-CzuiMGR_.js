...
import { createDisposalBin, createScope, deferredPromise, effect, isFunction, listenEvent, peek, signal, tick, useSignal } from "./vidstack-B9fTkxQO.js";
import { TimeRange, isRemotionSrc } from "./vidstack-CvezEmSQ.js";
import { ErrorBoundary, REMOTION_PROVIDER_ID, RemotionContextProvider, RemotionLayoutEngine } from "./vidstack-DQWW90ju.js";
...
var RemotionProvider = class {
	...
	render = () => {
		...
		if (!$src) throw Error("[vidstack] no src");
		React.useEffect(() => {
			if (!isRemotionSrc($src)) return;
