...
import { animationFrameThrottle, createDisposalBin, noop } from "./vidstack-CwMT4VYg.js";
import { IS_SERVER } from "./vidstack-CCoO65F7.js";
import * as React from "react";
import { Internals } from "remotion";
//#region src/providers/remotion/layout-engine.ts
var RemotionLayoutEngine = class {
	...
	#calcTransform(rect, scale) {
		if (!this.#src) return {};
		const correction = 0 - (1 - scale) / 2, x = correction * this.#src.compositionWidth, y = correction * this.#src.compositionHeight, width = this.#src.compositionWidth * scale, height = this.#src.compositionHeight * scale;
		return {
			x,
			y,
...
//#endregion
//#region src/providers/remotion/ui/context.tsx
const REMOTION_PROVIDER_ID = "vds-remotion-provider";
function RemotionContextProvider({ src: { compositionWidth: width, compositionHeight: height, fps, durationInFrames, numberOfSharedAudioTags }, component, timeline, mediaVolume, setMediaVolume, children, numberOfSharedAudioTags: providedNumberOfAudioTags }) {
	const compositionManager = React.useMemo(() => {
		return {
			...
			canvasContent: {
				type: "composition",
				compositionId: REMOTION_PROVIDER_ID
			},
	...
	return /* @__PURE__ */ React.createElement(Internals.IsPlayerContextProvider, null, /* @__PURE__ */ React.createElement(Internals.CanUseRemotionHooksProvider, null, /* @__PURE__ */ React.createElement(Internals.Timeline.TimelineContext.Provider, { value: timeline }, /* @__PURE__ */ React.createElement(Internals.CompositionManager.Provider, { value: compositionManager }, /* @__PURE__ */ React.createElement(Internals.SequenceManager.Provider, { value: sequenceManager }, /* @__PURE__ */ React.createElement(Internals.ResolveCompositionConfig, null, /* @__PURE__ */ React.createElement(Internals.PrefetchProvider, null, /* @__PURE__ */ React.createElement(Internals.DurationsContextProvider, null, /* @__PURE__ */ React.createElement(Internals.MediaVolumeContext.Provider, { value: mediaVolume }, /* @__PURE__ */ React.createElement(Internals.NativeLayersProvider, null, /* @__PURE__ */ React.createElement(Internals.SetMediaVolumeContext.Provider, { value: setMediaVolume }, /* @__PURE__ */ React.createElement(Internals.SharedAudioContextProvider, {
...
//#endregion
//#region src/providers/remotion/ui/error-boundary.tsx
const errorStyle = {};
var ErrorBoundary = class extends React.Component {
	...
	render() {
		...
		if (error) return /* @__PURE__ */ React.createElement("div", { style: errorStyle }, this.props.fallback?.(error) ?? /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "bold" } }, "An error has occurred, see console for more information."));
		return this.props.children;
	}
};
//#endregion
export { ErrorBoundary, REMOTION_PROVIDER_ID, RemotionContextProvider, RemotionLayoutEngine };
