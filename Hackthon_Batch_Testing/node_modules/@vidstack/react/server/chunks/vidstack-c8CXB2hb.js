...
import { composeRefs, createReactComponent, effect, isString, noop, signal, useReactContext, useSignal, useStateContext } from "./vidstack-CwMT4VYg.js";
import { AirPlayButtonInstance, CaptionButtonInstance, FullscreenButtonInstance, GestureInstance, LiveButtonInstance, MenuButtonInstance, MenuInstance, MenuItemInstance, MenuItemsInstance, MuteButtonInstance, PIPButtonInstance, PlayButtonInstance, Primitive, RadioGroupInstance, RadioInstance, SeekButtonInstance, SliderChaptersInstance, SliderInstance, SliderPreviewInstance, SliderThumbnailInstance, SliderValueInstance, SliderVideoInstance, ThumbnailInstance, TimeInstance, TimeSliderInstance, VolumeSliderInstance, mediaContext, mediaState, sortVideoQualities, useMediaState } from "./vidstack-Dke-J4nH.js";
import { IS_SERVER, isTrackCaptionKind } from "./vidstack-CCoO65F7.js";
import { useSliderState } from "./vidstack-BVuyJ32A.js";
import * as React from "react";
import { createPortal } from "react-dom";
//#region src/hooks/use-media-context.ts
function useMediaContext() {
	return useReactContext(mediaContext);
}
//#endregion
//#region src/components/ui/buttons/airplay-button.tsx
const AirPlayButtonBridge = createReactComponent(AirPlayButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const AirPlayButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(AirPlayButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
...
//#endregion
//#region src/components/ui/buttons/play-button.tsx
const PlayButtonBridge = createReactComponent(PlayButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const PlayButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(PlayButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/buttons/caption-button.tsx
const CaptionButtonBridge = createReactComponent(CaptionButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const CaptionButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(CaptionButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/buttons/fullscreen-button.tsx
const FullscreenButtonBridge = createReactComponent(FullscreenButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const FullscreenButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(FullscreenButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/buttons/mute-button.tsx
const MuteButtonBridge = createReactComponent(MuteButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const MuteButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(MuteButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/buttons/pip-button.tsx
const PIPButtonBridge = createReactComponent(PIPButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const PIPButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(PIPButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/buttons/seek-button.tsx
const SeekButtonBridge = createReactComponent(SeekButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const SeekButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(SeekButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/buttons/live-button.tsx
const LiveButtonBridge = createReactComponent(LiveButtonInstance, { domEventsRegex: /^onMedia/ });
/**
...
* ```
*/
const LiveButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(LiveButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/sliders/slider-callbacks.ts
...
//#endregion
//#region src/components/ui/sliders/slider-value.tsx
const SliderValueBridge = createReactComponent(SliderValueInstance);
//#endregion
//#region src/components/ui/sliders/slider.tsx
...
const SliderBridge = createReactComponent(SliderInstance, { events: sliderCallbacks });
/**
...
const Root$5 = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(SliderBridge, {
		...props,
		ref: forwardRef
...
* ```
*/
const Thumb = React.forwardRef((props, forwardRef) => /* @__PURE__ */ React.createElement(Primitive.div, {
	...props,
	ref: forwardRef
}));
...
* ```
*/
const Track = React.forwardRef((props, forwardRef) => /* @__PURE__ */ React.createElement(Primitive.div, {
	...props,
	ref: forwardRef
}));
...
* ```
*/
const TrackFill = React.forwardRef((props, forwardRef) => /* @__PURE__ */ React.createElement(Primitive.div, {
	...props,
	ref: forwardRef
}));
...
* ```
*/
const Preview = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(PreviewBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
const Value = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(SliderValueBridge, props, (props, instance) => {
...
//#endregion
//#region src/components/ui/sliders/volume-slider.tsx
var volume_slider_exports = /* @__PURE__ */ __exportAll({
	Preview: () => Preview,
	Root: () => Root$4,
	Steps: () => Steps,
	Thumb: () => Thumb,
...
const Root$4 = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(VolumeSliderBridge, {
		...props,
		ref: forwardRef
	}, (props) => /* @__PURE__ */ React.createElement(Primitive.div, props, children));
});
...
//#endregion
//#region src/components/ui/thumbnail.tsx
...
const Root$3 = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(ThumbnailBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/sliders/time-slider.tsx
var time_slider_exports = /* @__PURE__ */ __exportAll({
...
const TimeSliderContext = React.createContext({ $chapters: signal(null) });
...
const Root$2 = React.forwardRef(({ children, ...props }, forwardRef) => {
	...
	return /* @__PURE__ */ React.createElement(TimeSliderContext.Provider, { value: { $chapters } }, /* @__PURE__ */ React.createElement(TimeSliderBridge, {
		...props,
		ref: forwardRef
	}, (props) => /* @__PURE__ */ React.createElement(Primitive.div, props, children)));
});
...
* ```
*/
const Chapters = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(SliderChaptersBridge, props, (props, instance) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
...
* ```
*/
const ChapterTitle = React.forwardRef(({ children, ...props }, forwardRef) => {
...
* ```
*/
const Progress = React.forwardRef((props, forwardRef) => /* @__PURE__ */ React.createElement(Primitive.div, {
	...props,
	ref: forwardRef
}));
...
* ```
*/
const ThumbnailRoot = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(SliderThumbnailBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
const VideoBridge = createReactComponent(SliderVideoInstance, { events: ["onCanPlay", "onError"] });
/**
...
* ```
*/
const Video = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(VideoBridge, props, (props, instance) => /* @__PURE__ */ React.createElement(VideoProvider, {
		...props,
		instance,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
...
const VideoProvider = React.forwardRef(({ instance, children, ...props }, forwardRef) => {
	...
	return /* @__PURE__ */ React.createElement(Primitive.video, {
...
const RadioGroupBridge = createReactComponent(RadioGroupInstance, { events: ["onChange"] });
/**
...
const Root$1 = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(RadioGroupBridge, {
		...props,
		ref: forwardRef
	}, (props) => /* @__PURE__ */ React.createElement(Primitive.div, props, children));
});
Root$1.displayName = "RadioGroup";
const ItemBridge$1 = createReactComponent(RadioInstance, { events: ["onChange", "onSelect"] });
/**
...
const Item$1 = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(ItemBridge$1, props, (props) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
const Root = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(MenuBridge, {
		...props,
		ref: forwardRef
	}, (props, instance) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		style: {
...
const ButtonBridge = createReactComponent(MenuButtonInstance, { events: ["onSelect"] });
/**
...
const Button = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(ButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
* ```
*/
const Portal = React.forwardRef(({ container = null, disabled = false, children, ...props }, forwardRef) => {
	...
	return !target || !shouldPortal ? children : createPortal(/* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		style: {
			display: "contents",
			...props.style
...
const Items = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(ItemsBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
const Item = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(ItemBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
});
...
//#endregion
//#region src/components/ui/gesture.tsx
const GestureBridge = createReactComponent(GestureInstance, { events: ["onWillTrigger", "onTrigger"] });
/**
...
* ```
*/
const Gesture = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(GestureBridge, {
		...props,
		ref: forwardRef
	}, (props) => /* @__PURE__ */ React.createElement(Primitive.div, props, children));
});
...
//#endregion
//#region src/components/ui/time.tsx
...
const Time = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(TimeBridge, props, (props, instance) => /* @__PURE__ */ React.createElement(TimeText, {
		...props,
		instance,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
...
const TimeText = React.forwardRef(({ instance, children, ...props }, forwardRef) => {
...
function useMediaPlayer() {
	return useMediaContext()?.player || null;
}
//#endregion
//#region src/hooks/options/use-audio-options.ts
/**
...
function useAudioOptions() {
	...
	return React.useMemo(() => {
		...
		Object.defineProperty(options, "selectedTrack", { get() {
			return audioTrack();
		} });
...
//#endregion
//#region src/hooks/options/use-caption-options.ts
/**
...
//#endregion
//#region src/hooks/options/use-video-quality-options.ts
/**
...
function useVideoQualityOptions({ auto = true, sort = "descending" } = {}) {
	...
	return React.useMemo(() => {
		...
		Object.defineProperty(options, "selectedQuality", { get() {
			return quality();
		} });
		Object.defineProperty(options, "selectedValue", { get() {
...
//#endregion
export { AirPlayButton, Button, CaptionButton, ChapterTitle, Chapters, FullscreenButton, Gesture, Img, Item$1 as Item, Items, LiveButton, MuteButton, PIPButton, PlayButton, Portal, Preview, Progress, Root, Root$1, Root$2, Root$3, Root$4, Root$5, SeekButton, Steps, Thumb, Thumbnail, Time, Track, TrackFill, Value, appendParamsToURL, menu_exports, radio_group_exports, sliderCallbacks, slider_exports, thumbnail_exports, time_slider_exports, useAudioOptions, useCaptionOptions, useMediaContext, useMediaPlayer, useVideoQualityOptions, volume_slider_exports };
