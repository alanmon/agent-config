...
var AudioProviderLoader = class {
	...
	async load(ctx) {
		...
		return new (await (import("./vidstack-D1SiGeCA.js"))).AudioProvider(this.target, ctx);
	}
};
//#endregion
...
var VideoProviderLoader = class {
	...
	async load(ctx) {
		...
		return new (await (import("./vidstack-CCoO65F7.js").then((n) => n.provider_exports$1))).VideoProvider(this.target, ctx);
	}
};
//#endregion
...
var HLSProviderLoader = class HLSProviderLoader extends VideoProviderLoader {
	...
	async load(context) {
		...
		return new (await (import("./vidstack-Bve3g_KL.js"))).HLSProvider(this.target, context);
	}
};
//#endregion
...
var DASHProviderLoader = class DASHProviderLoader extends VideoProviderLoader {
	...
	async load(context) {
		...
		return new (await (import("./vidstack-CCoO65F7.js").then((n) => n.provider_exports))).DASHProvider(this.target, context);
	}
};
//#endregion
...
var VimeoProviderLoader = class {
	...
	async load(ctx) {
		...
		return new (await (import("./vidstack-B45USiXr.js"))).VimeoProvider(this.target, ctx);
	}
...
var YouTubeProviderLoader = class {
	...
	async load(ctx) {
		...
		return new (await (import("./vidstack-BlnGZSeG.js"))).YouTubeProvider(this.target, ctx);
	}
	async loadPoster(src, ctx, abort) {
	...
	async requestGoogleCast(trigger) {
		try {
			...
			if (!this.#googleCastLoader) {
				const $module = await import("./vidstack-BhnQz7VC.js");
