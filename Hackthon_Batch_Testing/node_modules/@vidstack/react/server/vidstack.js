...
import { __exportAll } from "./chunks/vidstack-BLEs9rMG.js";
import { Component, DOMEvent, EventsController, appendTriggerEvent, composeRefs, createReactComponent, effect, findTriggerEvent, hasProvidedContext, hasTriggerEvent, isKeyboardClick, isKeyboardEvent, isPointerEvent, isString, method, prop, useContext, useReactScope, useSignal, useSignalRecord, useStateContext, walkTriggerEventChain } from "./chunks/vidstack-CwMT4VYg.js";
import { ARIAKeyShortcuts, AirPlayButtonInstance, AudioGainSliderInstance, AudioProviderLoader, AudioTrackList, CaptionButtonInstance, CaptionsInstance, ControlsGroupInstance, ControlsInstance, DASHProviderLoader, FullscreenButtonInstance, FullscreenController, GestureInstance, GoogleCastButtonInstance, HLSProviderLoader, List, LiveButtonInstance, LocalMediaStorage, Logger, MEDIA_KEY_SHORTCUTS, MediaAnnouncerInstance, MediaControls, MediaPlayerInstance, MediaProviderInstance, MediaRemoteControl, MenuButtonInstance, MenuInstance, MenuItemInstance, MenuItemsInstance, MenuPortalInstance, MuteButtonInstance, PIPButtonInstance, PlayButtonInstance, PosterInstance, Primitive, QualitySliderInstance, RadioGroupController, RadioGroupInstance, RadioInstance, ScreenOrientationController, SeekButtonInstance, SliderChaptersInstance, SliderInstance, SliderPreviewInstance, SliderThumbnailInstance, SliderValueInstance, SliderVideoInstance, SpeedSliderInstance, TextRenderers, TextTrackList, ThumbnailInstance, ThumbnailsLoader, TimeInstance, TimeSliderInstance, ToggleButtonInstance, TooltipContentInstance, TooltipInstance, TooltipTriggerInstance, VideoProviderLoader, VideoQualityList, VimeoProviderLoader, VolumeSliderInstance, YouTubeProviderLoader, boundTime, canFullscreen, formatSpokenTime, formatTime, isAudioProvider, isDASHProvider, isGoogleCastProvider, isHLSProvider, isHTMLAudioElement, isHTMLIFrameElement, isHTMLMediaElement, isHTMLVideoElement, isVideoProvider, isVideoQualitySrc, isVimeoProvider, isYouTubeProvider, mediaContext, mediaState, menuContext, sliderState, softResetMediaState, sortVideoQualities, updateSliderPreviewPlacement, useMediaContext as useMediaContext$1, useMediaState, useMediaStore } from "./chunks/vidstack-Dke-J4nH.js";
import { AUDIO_EXTENSIONS, AUDIO_TYPES, DASH_VIDEO_EXTENSIONS, DASH_VIDEO_TYPES, HLS_VIDEO_EXTENSIONS, HLS_VIDEO_TYPES, TextTrack, TextTrackSymbol, TimeRange, VIDEO_EXTENSIONS, VIDEO_TYPES, canChangeVolume, canGoogleCastSrc, canOrientScreen, canPlayHLSNatively, canRotateScreen, canUsePictureInPicture, canUseVideoPresentation, findActiveCue, getDownloadFile, getTimeRangesEnd, getTimeRangesStart, isAudioSrc, isCueActive, isDASHSrc, isHLSSrc, isMediaStream, isRemotionProvider, isTrackCaptionKind, isVideoSrc, normalizeTimeIntervals, parseJSONCaptionsFile, updateTimeIntervals, watchActiveTextTrack, watchCueTextChange } from "./chunks/vidstack-CCoO65F7.js";
import { DEFAULT_PLAYBACK_RATES, useMediaRemote, usePlaybackRateOptions } from "./chunks/vidstack-DsTBQRYw.js";
import { Captions, ChapterTitle, GoogleCastButton, MediaAnnouncer, Title, audio_gain_slider_exports, controls_exports, createSignal, speed_slider_exports, spinner_exports, tooltip_exports, useActiveTextCues, useActiveTextTrack, useChapterOptions, useChapterTitle, useScoped, useTextCues } from "./chunks/vidstack-DZmhm_7Y.js";
import { AirPlayButton, CaptionButton, FullscreenButton, Gesture, LiveButton, MuteButton, PIPButton, PlayButton, Preview, SeekButton, Steps, Thumb, Time, Track as Track$1, TrackFill, Value, menu_exports, radio_group_exports, sliderCallbacks, slider_exports, thumbnail_exports, time_slider_exports, useAudioOptions, useCaptionOptions, useMediaContext, useMediaPlayer, useVideoQualityOptions, volume_slider_exports } from "./chunks/vidstack-c8CXB2hb.js";
import { Icon } from "./chunks/vidstack-BUARUqHF.js";
import { useSliderState, useSliderStore } from "./chunks/vidstack-BVuyJ32A.js";
import * as React from "react";
//#region ../vidstack/src/core/tracks/text/render/libass-text-renderer.ts
...
//#endregion
//#region ../vidstack/src/components/ui/menu/radio-groups/audio-gain-radio-group.ts
...
//#endregion
//#region src/components/player.tsx
...
* ```
*/
const MediaPlayer = React.forwardRef(({ aspectRatio, children, ...props }, forwardRef) => {
	...
	}, (props) => /* @__PURE__ */ React.createElement(Primitive.div, props, children));
});
...
* ```
*/
const MediaProvider = React.forwardRef(({ loaders = [], children, iframeProps, mediaProps, ...props }, forwardRef) => {
	...
	return /* @__PURE__ */ React.createElement(MediaProviderBridge, {
		...
		ref: forwardRef
	}, (props, instance) => /* @__PURE__ */ React.createElement("div", props, /* @__PURE__ */ React.createElement(MediaOutlet, {
		provider: instance,
		mediaProps,
		iframeProps
	}), children));
...
function MediaOutlet({ provider, mediaProps, iframeProps }) {
	...
	const loadProviderRef = React.useCallback((el) => {
		provider.load(el);
	}, [provider]);
	React.useEffect(() => {
		if (!isGoogleCast || googleCastIconPaths) return;
		import("./chunks/vidstack-CwMT4VYg.js").then((n) => n.chromecast_exports).then((mod) => {
	...
	if (isGoogleCast) return /* @__PURE__ */ React.createElement("div", {
		className: "vds-google-cast",
		ref: loadProviderRef
	}, /* @__PURE__ */ React.createElement(Icon, { paths: googleCastIconPaths }), $remoteInfo?.deviceName ? /* @__PURE__ */ React.createElement("span", { className: "vds-google-cast-info" }, "Google Cast on", " ", /* @__PURE__ */ React.createElement("span", { className: "vds-google-cast-device-name" }, $remoteInfo.deviceName)) : null);
	if (isRemotion) return /* @__PURE__ */ React.createElement("div", { "data-remotion-canvas": true }, /* @__PURE__ */ React.createElement("div", {
	...
	return isEmbed ? React.createElement(React.Fragment, null, React.createElement("iframe", {
		...
		ref: loadProviderRef
	}), !$nativeControls && !isAudioView ? React.createElement("div", { className: "vds-blocker" }) : null) : $mediaType ? React.createElement($mediaType === "audio" ? "audio" : "video", {
		...mediaProps,
		...
		suppressHydrationWarning: true,
		children: !hasMounted ? $sources.map(({ src, type }) => isString(src) ? /* @__PURE__ */ React.createElement("source", {
			src,
...
//#endregion
//#region src/hooks/create-text-track.ts
/**
...
//#endregion
//#region src/components/text-track.tsx
/**
* Creates a new `TextTrack` object and adds it to the player.
*
...
//#endregion
//#region src/components/ui/buttons/toggle-button.tsx
...
* ```
*/
const ToggleButton = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(ToggleButtonBridge, props, (props) => /* @__PURE__ */ React.createElement(Primitive.button, {
		...props,
...
//#endregion
//#region src/components/ui/sliders/quality-slider.tsx
var quality_slider_exports = /* @__PURE__ */ __exportAll({
	Preview: () => Preview,
	Root: () => Root$1,
	Steps: () => Steps,
	Thumb: () => Thumb,
...
const Root$1 = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(QualitySliderBridge, {
		...props,
		ref: forwardRef
	}, (props) => /* @__PURE__ */ React.createElement(Primitive.div, props, children));
});
Root$1.displayName = "QualitySlider";
//#endregion
//#region src/components/ui/poster.tsx
...
* ```
*/
const Poster = React.forwardRef(({ children, ...props }, forwardRef) => {
	return /* @__PURE__ */ React.createElement(PosterBridge, {
		...
		...props
	}, (props, instance) => /* @__PURE__ */ React.createElement(PosterImg, {
		...props,
		instance,
		ref: composeRefs(props.ref, forwardRef)
	}, children));
...
const PosterImg = React.forwardRef(({ instance, children, ...props }, forwardRef) => {
...
//#endregion
//#region src/components/ui/caption.tsx
var caption_exports = /* @__PURE__ */ __exportAll({
	Root: () => Root,
	Text: () => Text
});
...
function useStore(ctor, ref) {
	const initialStore = React.useMemo(() => {
		...
		if (!store) {
			store = new Proxy(ctor.state.record, { get: (_, prop) => () => ctor.state.record[prop] });
...
//#endregion
//#region src/hooks/use-media-provider.ts
/**
...
//#endregion
//#region src/hooks/use-thumbnails.ts
/**
...
function useThumbnails(src, crossOrigin = null) {
	useReactScope();
	const $src = createSignal(src), $crossOrigin = createSignal(crossOrigin), loader = useScoped(() => ThumbnailsLoader.create($src, $crossOrigin));
	React.useEffect(() => {
		$src.set(src);
	}, [src]);
	React.useEffect(() => {
...
//#endregion
//#region src/hooks/use-slider-preview.ts
/**
...
function useSliderPreview({ clamp = false, offset = 0, orientation = "horizontal" } = {}) {
	...
	React.useEffect(() => {
		if (!rootRef) return;
		const root = rootRef;
		let isDragging = false, dragEvents = null;
		...
		function onPointerDown(event) {
			...
			dragEvents = new EventsController(document).add("pointerup", onPointerUp).add("pointermove", updatePointerValue).add("touchmove", (e) => e.preventDefault(), { passive: false });
		}
		...
		const rootEvents = new EventsController(root).add("pointerenter", () => setVisible(true)).add("pointerdown", onPointerDown).add("pointerleave", () => {
	...
	React.useEffect(() => {
		if (previewRef) previewRef.style.setProperty("--slider-pointer", pointerValue + "%");
...
//#endregion
//#region src/hooks/options/use-audio-gain-options.ts
/**
...
//#endregion
export { ARIAKeyShortcuts, AUDIO_EXTENSIONS, AUDIO_TYPES, AirPlayButton, AirPlayButtonInstance, audio_gain_slider_exports as AudioGainSlider, AudioGainSliderInstance, AudioProviderLoader, AudioTrackList, caption_exports as Caption, CaptionButton, CaptionButtonInstance, Captions, CaptionsInstance, ChapterTitle, controls_exports as Controls, ControlsGroupInstance, ControlsInstance, DASHProviderLoader, DASH_VIDEO_EXTENSIONS, DASH_VIDEO_TYPES, DEFAULT_AUDIO_GAINS, DEFAULT_PLAYBACK_RATES, FullscreenButton, FullscreenButtonInstance, FullscreenController, Gesture, GestureInstance, GoogleCastButton, GoogleCastButtonInstance, HLSProviderLoader, HLS_VIDEO_EXTENSIONS, HLS_VIDEO_TYPES, Icon, LibASSTextRenderer, List, LiveButton, LiveButtonInstance, LocalMediaStorage, Logger, MEDIA_KEY_SHORTCUTS, MediaAnnouncer, MediaAnnouncerInstance, MediaControls, MediaPlayer, MediaPlayerInstance, MediaProvider, MediaProviderInstance, MediaRemoteControl, menu_exports as Menu, MenuButtonInstance, MenuInstance, MenuItemInstance, MenuItemsInstance, MenuPortalInstance, MuteButton, MuteButtonInstance, PIPButton, PIPButtonInstance, PlayButton, PlayButtonInstance, Poster, PosterInstance, quality_slider_exports as QualitySlider, QualitySliderInstance, radio_group_exports as RadioGroup, RadioGroupInstance, RadioInstance, ScreenOrientationController, SeekButton, SeekButtonInstance, slider_exports as Slider, SliderChaptersInstance, SliderInstance, SliderPreviewInstance, SliderThumbnailInstance, SliderValueInstance, SliderVideoInstance, speed_slider_exports as SpeedSlider, SpeedSliderInstance, spinner_exports as Spinner, TextRenderers, TextTrack, TextTrackList, thumbnail_exports as Thumbnail, ThumbnailInstance, Time, TimeInstance, TimeRange, time_slider_exports as TimeSlider, TimeSliderInstance, Title, ToggleButton, ToggleButtonInstance, tooltip_exports as Tooltip, TooltipContentInstance, TooltipInstance, TooltipTriggerInstance, Track, VIDEO_EXTENSIONS, VIDEO_TYPES, VideoProviderLoader, VideoQualityList, VimeoProviderLoader, volume_slider_exports as VolumeSlider, VolumeSliderInstance, YouTubeProviderLoader, appendTriggerEvent, boundTime, canChangeVolume, canFullscreen, canGoogleCastSrc, canOrientScreen, canPlayHLSNatively, canRotateScreen, canUsePictureInPicture, canUseVideoPresentation, createTextTrack, findActiveCue, findTriggerEvent, formatSpokenTime, formatTime, getDownloadFile, getTimeRangesEnd, getTimeRangesStart, hasTriggerEvent, isAudioProvider, isAudioSrc, isCueActive, isDASHProvider, isDASHSrc, isGoogleCastProvider, isHLSProvider, isHLSSrc, isHTMLAudioElement, isHTMLIFrameElement, isHTMLMediaElement, isHTMLVideoElement, isKeyboardClick, isKeyboardEvent, isMediaStream, isPointerEvent, isTrackCaptionKind, isVideoProvider, isVideoQualitySrc, isVideoSrc, isVimeoProvider, isYouTubeProvider, mediaContext, mediaState, normalizeTimeIntervals, parseJSONCaptionsFile, sliderState, softResetMediaState, sortVideoQualities, updateTimeIntervals, useActiveTextCues, useActiveTextTrack, useActiveThumbnail, useAudioGainOptions, useAudioOptions, useCaptionOptions, useChapterOptions, useChapterTitle, useMediaContext, useMediaPlayer, useMediaProvider, useMediaRemote, useMediaState, useMediaStore, usePlaybackRateOptions, useSliderPreview, useSliderState, useSliderStore, useState, useStore, useTextCues, useThumbnails, useVideoQualityOptions, walkTriggerEventChain, watchActiveTextTrack, watchCueTextChange };
