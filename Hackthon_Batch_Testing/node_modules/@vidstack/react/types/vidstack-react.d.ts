import { AirPlayButtonInstance, AnyRecord, AudioGainSliderInstance, AudioTrack, CaptionButtonInstance, CaptionsInstance, Component, ControlsGroupInstance, ControlsInstance, DefaultLayoutTranslations, FileDownloadInfo, FullscreenButtonInstance, GestureInstance, GoogleCastButtonInstance, InferComponentCSSVars, InferComponentEvents, InferComponentProps, InferEventDetail, LiveButtonInstance, MediaAnnouncerInstance, MediaContext, MediaCrossOrigin, MediaPlayerInstance, MediaPlayerQuery, MediaProviderAdapter, MediaProviderInstance, MediaProviderLoader, MediaRemoteControl, MediaState, MediaType, MenuButtonInstance, MenuInstance, MenuItemInstance, MenuItemsInstance, MenuPortalInstance, MuteButtonInstance, PIPButtonInstance, PascalCase, PlayButtonInstance, PlayerSrc as PlayerSrc$1, PlyrControl, PlyrLayoutTranslations, PlyrLayoutWord, PlyrMarker, PosterInstance, QualitySliderInstance, RadioGroupInstance, RadioInstance, ReadSignal, Scope, SeekButtonInstance, SliderChaptersInstance, SliderInstance, SliderOrientation, SliderPreviewInstance, SliderState, SliderThumbnailInstance, SliderValueInstance, SliderVideoInstance, SpeedSliderInstance, Src, State, TextTrack, TextTrackInit, ThumbnailImage, ThumbnailInstance, ThumbnailSrc, TimeInstance, TimeSliderInstance, ToggleButtonInstance, TooltipContentInstance, TooltipInstance, TooltipPlacement, TooltipTriggerInstance, VTTContent, VideoQuality, VolumeSliderInstance, WriteSignal } from "./vidstack-instances.js";
import { CaptionsFileFormat, CaptionsParserFactory, VTTCue } from "media-captions";
import * as React from "react";

//#region ../vidstack/types/utils/time.d.ts
 ...
 */
declare function formatTime(duration: number, {
  padHrs,
  padMins,
  showHrs,
  showMs
...
//#endregion
//#region ../vidstack/types/utils/mime.d.ts
...
declare function isAudioSrc({
  src,
  type
}: Src): boolean;
declare function isVideoSrc(src: Src): boolean;
declare function isHLSSrc({
  src,
  type
}: Src): boolean;
declare function isDASHSrc({
  src,
  type
}: Src): boolean;
...
//#endregion
//#region ../vidstack/types/utils/support.d.ts
/**
...
//#endregion
//#region types/react/src/providers/remotion/types.d.ts
...
//#endregion
//#region types/react/src/source.d.ts
type PlayerSrc = PlayerSrc$1 | RemotionSrc;
//#endregion
//#region ../../node_modules/.pnpm/maverick.js@0.44.1/node_modules/maverick.js/dist/dev/react.d.ts
...
type ReactEventCallbacks<E> = { [Type in keyof E as `on${PascalCase<Type & string>}`]?: (InferEventDetail<E[Type]> extends void ? (nativeEvent: E[Type]) => void : (detail: InferEventDetail<E[Type]>, nativeEvent: E[Type]) => void) | undefined };
//#endregion
//#region types/react/src/components/player.d.ts
...
//#endregion
//#region types/react/src/components/announcer.d.ts
...
//#endregion
//#region types/react/src/components/provider.d.ts
...
//#endregion
//#region types/react/src/icon.d.ts
...
declare const Icon$1: IconComponent;
//#endregion
//#region types/react/src/components/text-track.d.ts
/**
...
declare namespace controls_d_exports {
  export { Group, GroupProps, Root$12 as Root, RootProps$12 as RootProps };
}
interface RootProps$12 extends ReactElementProps<ControlsInstance> {
  asChild?: boolean;
  children?: React.ReactNode;
  ref?: React.Ref<HTMLElement>;
}
 ...
 * ```
 */
declare const Root$12: React.ForwardRefExoticComponent<Omit<RootProps$12, "ref"> & React.RefAttributes<HTMLElement>>;
...
declare namespace tooltip_d_exports {
  export { Content, ContentProps, Root$11 as Root, RootProps$11 as RootProps, Trigger, TriggerProps };
}
interface RootProps$11 extends ReactProps<TooltipInstance> {
  asChild?: boolean;
  children: React.ReactNode;
}
/**
...
declare function Root$11({
  children,
  ...props
}: RootProps$11): React.JSX.Element;
declare namespace Root$11 {
  var displayName: string;
}
...
//#endregion
//#region types/react/src/components/ui/buttons/toggle-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/airplay-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/google-cast-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/play-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/caption-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/fullscreen-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/mute-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/pip-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/seek-button.d.ts
...
//#endregion
//#region types/react/src/components/ui/buttons/live-button.d.ts
...
//#endregion
//#region types/react/src/components/primitives/nodes.d.ts
...
//#endregion
//#region types/react/src/components/ui/sliders/slider-value.d.ts
...
declare namespace slider_d_exports {
  export { Preview, PreviewProps, Root$10 as Root, RootProps$10 as RootProps, Steps, StepsProps, Thumb, ThumbProps, Track$1 as Track, TrackFill$1 as TrackFill, TrackFillProps$1 as TrackFillProps, TrackProps$1 as TrackProps, Value, ValueProps };
}
interface RootProps$10 extends ReactElementProps<SliderInstance> {
  asChild?: boolean;
  children?: React.ReactNode;
 ...
 * ```
 */
declare const Root$10: React.ForwardRefExoticComponent<Omit<RootProps$10, "ref"> & React.RefAttributes<SliderInstance>>;
...
declare namespace volume_slider_d_exports {
  export { Preview, PreviewProps, Root$9 as Root, RootProps$9 as RootProps, Steps, StepsProps, Thumb, ThumbProps, Track$1 as Track, TrackFill$1 as TrackFill, TrackFillProps$1 as TrackFillProps, TrackProps$1 as TrackProps, Value, ValueProps };
}
...
declare namespace quality_slider_d_exports {
  export { Preview, PreviewProps, Root$8 as Root, RootProps$8 as RootProps, Steps, StepsProps, Thumb, ThumbProps, Track$1 as Track, TrackFill$1 as TrackFill, TrackFillProps$1 as TrackFillProps, TrackProps$1 as TrackProps, Value, ValueProps };
}
...
declare namespace audio_gain_slider_d_exports {
  export { Preview, PreviewProps, Root$7 as Root, RootProps$7 as RootProps, Steps, StepsProps, Thumb, ThumbProps, Track$1 as Track, TrackFill$1 as TrackFill, TrackFillProps$1 as TrackFillProps, TrackProps$1 as TrackProps, Value, ValueProps };
}
...
declare namespace speed_slider_d_exports {
  export { Preview, PreviewProps, Root$6 as Root, RootProps$6 as RootProps, Steps, StepsProps, Thumb, ThumbProps, Track$1 as Track, TrackFill$1 as TrackFill, TrackFillProps$1 as TrackFillProps, TrackProps$1 as TrackProps, Value, ValueProps };
}
...
declare namespace thumbnail_d_exports {
  export { Img, ImgProps, Root$5 as Root, RootProps$5 as RootProps };
}
...
declare namespace time_slider_d_exports {
  export { ChapterTitle$1 as ChapterTitle, ChapterTitleProps$1 as ChapterTitleProps, Chapters, ChaptersProps, Preview, PreviewProps, Progress, ProgressProps, Root$4 as Root, RootProps$4 as RootProps, Steps, StepsProps, Thumb, ThumbProps, Thumbnail, ThumbnailImgProps, ThumbnailProps, Track$1 as Track, TrackFill$1 as TrackFill, TrackFillProps$1 as TrackFillProps, TrackProps$1 as TrackProps, Value, ValueProps, Video, VideoProps, VideoProviderProps };
}
...
declare namespace radio_group_d_exports {
  export { Item$1 as Item, ItemProps$1 as ItemProps, Root$3 as Root, RootProps$3 as RootProps };
}
...
declare namespace menu_d_exports {
  export { Button, ButtonProps, Items as Content, ItemsProps as ContentProps, Item, ItemProps, Items, ItemsProps, Portal, PortalProps, Item$1 as Radio, Root$3 as RadioGroup, RootProps$3 as RadioGroupProps, ItemProps$1 as RadioProps, Root$2 as Root, RootProps$2 as RootProps };
}
...
//#endregion
//#region types/react/src/components/ui/title.d.ts
...
//#endregion
//#region types/react/src/components/ui/chapter-title.d.ts
...
//#endregion
//#region types/react/src/components/ui/gesture.d.ts
...
//#endregion
//#region types/react/src/components/ui/captions.d.ts
...
//#endregion
//#region types/react/src/components/ui/poster.d.ts
...
//#endregion
//#region types/react/src/components/ui/time.d.ts
...
declare namespace caption_d_exports {
  export { Root$1 as Root, RootProps$1 as RootProps, Text, TextProps };
}
...
declare namespace spinner_d_exports {
  export { Root, RootProps, Track, TrackFill, TrackFillProps, TrackProps };
}
...
//#endregion
//#region types/react/src/hooks/use-state.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-media-context.d.ts
declare function useMediaContext(): MediaContext;
//#endregion
//#region types/react/src/hooks/use-media-player.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-media-provider.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-media-remote.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-media-state.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-thumbnails.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-slider-state.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-slider-preview.d.ts
/**
 * @docs {@link https://www.vidstack.io/docs/player/api/hooks/use-slider-preview}
 */
declare function useSliderPreview({
  clamp,
  offset,
  orientation
}?: UseSliderPreview): {
...
//#endregion
//#region types/react/src/hooks/use-text-cues.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-active-text-cues.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/use-active-text-track.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/options/use-audio-gain-options.d.ts
/**
 * @docs {@link https://www.vidstack.io/docs/player/api/hooks/use-audio-gain-options}
 */
declare function useAudioGainOptions({
  gains,
  disabledLabel
...
//#endregion
//#region types/react/src/hooks/options/use-audio-options.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/options/use-caption-options.d.ts
/**
 * @docs {@link https://www.vidstack.io/docs/player/api/hooks/use-caption-options}
 */
declare function useCaptionOptions({
  off
}?: UseCaptionOptions): CaptionOptions;
...
//#endregion
//#region types/react/src/hooks/options/use-chapter-options.d.ts
/**
...
//#endregion
//#region types/react/src/hooks/options/use-video-quality-options.d.ts
/**
 * @docs {@link https://www.vidstack.io/docs/player/api/hooks/use-video-quality-options}
 */
declare function useVideoQualityOptions({
  auto,
  sort
...
//#endregion
//#region types/react/src/hooks/options/use-playback-rate-options.d.ts
/**
 * @docs {@link https://www.vidstack.io/docs/player/api/hooks/use-playback-rate-options}
 */
declare function usePlaybackRateOptions({
  rates,
  normalLabel
...
//#endregion
//#region types/react/src/components/layouts/default/slots.d.ts
type SlotPositions$1<Name extends string> = `before${Capitalize<Name>}` | Name | `after${Capitalize<Name>}`;
type Slots$1<Names extends string> = { [slotName in SlotPositions$1<Names>]?: React.ReactNode };
...
type DefaultLayoutMenuSlotName = 'chaptersMenu' | 'settingsMenu' /** @deprecated - use `settingsMenuItemsStart` */ | 'settingsMenuStartItems' /** @deprecated - use `settingsMenuItemsEnd` */ | 'settingsMenuEndItems' | 'settingsMenuItemsStart' | 'settingsMenuItemsEnd' | 'speedMenuItemsStart' | 'speedMenuItemsEnd' | 'qualityMenuItemsStart' | 'qualityMenuItemsEnd' | 'accessibilityMenuItemsStart' | 'accessibilityMenuItemsEnd' | 'audioMenuItemsStart' | 'audioMenuItemsEnd' | 'captionsMenuItemsStart' | 'captionsMenuItemsEnd';
...
//#endregion
//#region types/react/src/components/layouts/default/icons.d.ts
...
//#endregion
//#region types/react/src/components/layouts/default/media-layout.d.ts
...
//#endregion
//#region types/react/src/components/layouts/default/context.d.ts
...
//#endregion
//#region types/react/src/components/layouts/default/audio-layout.d.ts
...
//#endregion
//#region types/react/src/components/layouts/default/video-layout.d.ts
...
//#endregion
//#region types/react/src/components/layouts/default/ui/menus/items/menu-checkbox.d.ts
...
declare function DefaultMenuCheckbox({
  label,
  checked,
  storageKey,
  defaultChecked,
  onChange
}: DefaultMenuCheckboxProps): React.JSX.Element;
declare namespace DefaultMenuCheckbox {
  var displayName: string;
}
//#endregion
//#region types/react/src/components/layouts/default/ui/menus/items/menu-items.d.ts
interface DefaultMenuSectionProps {
  label?: string;
  value?: string;
  children: React.ReactNode;
}
declare function DefaultMenuSection({
  label,
  value,
  children
}: DefaultMenuSectionProps): React.JSX.Element;
...
declare function DefaultMenuButton({
  label,
  hint,
  Icon,
  disabled
}: DefaultMenuButtonProps): React.JSX.Element;
...
declare function DefaultMenuItem({
  label,
  children
}: DefaultMenuItemProps): React.JSX.Element;
...
declare function DefaultMenuRadioGroup({
  value,
  options,
  onChange
}: DefaultMenuRadioGroupProps): React.JSX.Element;
...
//#endregion
//#region types/react/src/components/layouts/default/ui/menus/items/menu-slider.d.ts
...
declare function DefaultMenuSliderItem({
  label,
  value,
  UpIcon,
  DownIcon,
  ...
  isMin,
  isMax
}: DefaultMenuSliderItemProps): React.JSX.Element;
...
//#endregion
//#region types/react/src/components/layouts/default/ui/tooltip.d.ts
interface DefaultTooltipProps {
  content: string;
  placement?: TooltipPlacement;
  children: React.ReactNode;
}
declare function DefaultTooltip({
  content,
  placement,
  children
}: DefaultTooltipProps): React.JSX.Element;
declare namespace DefaultTooltip {
  var displayName: string;
}
//#endregion
//#region types/react/src/components/layouts/default/ui/keyboard-display.d.ts
...
//#endregion
//#region types/react/src/components/layouts/plyr/icons.d.ts
...
//#endregion
//#region types/react/src/components/layouts/plyr/slots.d.ts
type SlotPositions<Name extends string> = `before${Capitalize<Name>}` | Name | `after${Capitalize<Name>}`;
type Slots<Names extends string> = { [slotName in SlotPositions<Names>]?: React.ReactNode };
...
//#endregion
//#region types/react/src/components/layouts/plyr/props.d.ts
...
//#endregion
//#region types/react/src/components/layouts/plyr/layout.d.ts
...
//#endregion
//#region types/react/src/components/layouts/plyr/context.d.ts
...
//#endregion
//#region types/react/src/icons.d.ts
...
//#endregion
//#region types/react/src/providers/remotion/ui/thumbnail.d.ts
...
//#endregion
//#region types/react/src/providers/remotion/ui/poster.d.ts
...
//#endregion
//#region types/react/src/providers/remotion/ui/slider-thumbnail.d.ts
...
//#endregion
//#region types/react/src/providers/remotion/loader.d.ts
...
//#endregion
//#region types/react/src/providers/remotion/provider.d.ts
...
//#endregion
//#region types/react/src/providers/remotion/type-check.d.ts
...
//#endregion
export { AUDIO_EXTENSIONS, AUDIO_TYPES, AccessibilityIcon, AddIcon, AddNoteIcon, AddPlaylistIcon, AddUserIcon, AirPlayButton, AirPlayButtonProps, AirPlayIcon, ArrowCollapseIcon, ArrowCollapseInIcon, ArrowDownIcon, ArrowExpandIcon, ArrowExpandOutIcon, ArrowLeftIcon, ArrowRightIcon, ArrowUpIcon, AudioGainOption, AudioGainOptions, AudioOption, AudioOptions, BookmarkIcon, ButtonProps, CameraIcon, CaptionButton, CaptionButtonProps, CaptionOption, CaptionOptions, Captions, CaptionsProps, ChapterOption, ChapterOptions, ChapterTitle, ChapterTitleProps, ChapterTitleProps$1, ChaptersIcon, ChaptersProps, ChatCollapseIcon, ChatIcon, CheckIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, ChromecastIcon, ClipIcon, ClosedCaptionsIcon, ClosedCaptionsOnIcon, CommentIcon, ComputerIcon, ContentProps, DASH_VIDEO_EXTENSIONS, DASH_VIDEO_TYPES, DefaultAirPlayButtonIcons, DefaultAudioLayout, DefaultAudioLayoutProps, DefaultAudioLayoutSlots, DefaultBufferingIndicator, DefaultCaptionButtonIcons, DefaultDownloadButtonIcons, DefaultFullscreenButtonIcons, DefaultGoogleCastButtonIcons, DefaultKeyboardDisplay, DefaultKeyboardDisplayIcons, DefaultKeyboardDisplayProps, DefaultLayoutContext, DefaultLayoutIcon, DefaultLayoutIconProps, DefaultLayoutIcons, DefaultLayoutMenuSlotName, DefaultLayoutProps, DefaultLayoutSlotName, DefaultLayoutSlots, DefaultMenuButton, DefaultMenuButtonProps, DefaultMenuCheckbox, DefaultMenuCheckboxProps, DefaultMenuIcons, DefaultMenuItem, DefaultMenuItemProps, DefaultMenuRadioGroup, DefaultMenuRadioGroupProps, DefaultMenuSection, DefaultMenuSectionProps, DefaultMenuSliderItem, DefaultMenuSliderItemProps, DefaultMuteButtonIcons, DefaultPIPButtonIcons, DefaultPlayButtonIcons, DefaultSeekButtonIcons, DefaultSliderParts, DefaultSliderSteps, DefaultTooltip, DefaultTooltipProps, DefaultVideoGestures, DefaultVideoLargeLayout, DefaultVideoLayout, DefaultVideoLayoutProps, DefaultVideoLayoutSlots, DefaultVideoSmallLayout, DeviceIcon, DownloadIcon, EpisodesIcon, EyeIcon, FastBackwardIcon, FastForwardIcon, FlagIcon, FullscreenArrowExitIcon, FullscreenArrowIcon, FullscreenButton, FullscreenButtonProps, FullscreenExitIcon, FullscreenIcon, Gesture, GestureProps, GoogleCastButton, GoogleCastButtonProps, GroupProps, HLS_VIDEO_EXTENSIONS, HLS_VIDEO_TYPES, HeartIcon, Icon$1 as Icon, IconComponent, IconProps, ImgProps, InfoIcon, ItemProps, ItemProps$1, ItemsProps, LanguageIcon, LinkIcon, LiveButton, LiveButtonProps, LockClosedIcon, LockOpenIcon, MediaAnnouncer, MediaAnnouncerProps, MediaPlayer, MediaPlayerProps, MediaProvider, MediaProviderProps, MenuHorizontalIcon, MenuVerticalIcon, MicrophoneIcon, MobileIcon, MoonIcon, MusicIcon, MusicOffIcon, MuteButton, MuteButtonProps, MuteIcon, NextIcon, NoEyeIcon, NotificationIcon, OdometerIcon, PIPButton, PIPButtonProps, PauseIcon, PictureInPictureExitIcon, PictureInPictureIcon, PlayButton, PlayButtonProps, PlayIcon, PlaybackRateOption, PlaybackRateOptions, PlaybackSpeedCircleIcon, PlayerSrc, PlaylistIcon, PlyrAudioLayout, PlyrLayout, PlyrLayoutContext, PlyrLayoutElementProps, PlyrLayoutIcon, PlyrLayoutIconProps, PlyrLayoutIcons, PlyrLayoutProps, PlyrLayoutSlotName, PlyrLayoutSlots, PlyrVideoLayout, PortalProps, Poster, PosterProps, PreviewProps, PreviousIcon, QuestionMarkIcon, QueueListIcon, RadioButtonIcon, RadioButtonSelectedIcon, RemotionErrorRenderer, RemotionInputProps, RemotionLoadingRenderer, RemotionPoster, RemotionPosterProps, RemotionProvider, RemotionProviderLoader, RemotionSliderThumbnail, RemotionSliderThumbnailProps, RemotionSrc, RemotionThumbnail, RemotionThumbnailProps, RepeatIcon, RepeatOnIcon, RepeatSquareIcon, RepeatSquareOnIcon, ReplayIcon, RootProps, RootProps$1, RootProps$10, RootProps$11, RootProps$12, RootProps$2, RootProps$3, RootProps$4, RootProps$5, RootProps$6, RootProps$7, RootProps$8, RootProps$9, RotateIcon, SearchIcon, SeekBackward10Icon, SeekBackward15Icon, SeekBackward30Icon, SeekBackwardIcon, SeekButton, SeekButtonProps, SeekForward10Icon, SeekForward15Icon, SeekForward30Icon, SeekForwardIcon, SendIcon, SettingsIcon, SettingsMenuIcon, SettingsSwitchIcon, ShareArrowIcon, ShareIcon, ShuffleIcon, ShuffleOnIcon, StepsProps, StopIcon, SubtitlesIcon, SunIcon, TextProps, TheatreModeExitIcon, TheatreModeIcon, ThumbnailImgProps, ThumbnailProps, ThumbsDownIcon, ThumbsUpIcon, Time, TimeProps, TimerIcon, Title, TitleProps, ToggleButton, ToggleButtonProps, Track$2 as Track, TrackFillProps, TrackProps, TrackProps$2 as TrackProps$1, TranscriptIcon, TriggerProps, TvIcon, UseAudioGainOptions, UseCaptionOptions, UsePlaybackRateOptions, UseSliderPreview, UseVideoQualityOptions, UserIcon, VIDEO_EXTENSIONS, VIDEO_TYPES, ValueProps, VideoProps, VideoQualityOption, VideoQualityOptions, VolumeHighIcon, VolumeLowIcon, XMarkIcon, audio_gain_slider_d_exports, canChangeVolume, canGoogleCastSrc, canOrientScreen, canPlayHLSNatively, canRotateScreen, canUsePictureInPicture, canUseVideoPresentation, caption_d_exports, controls_d_exports, createRadioOptions, createTextTrack, defaultLayoutIcons, formatSpokenTime, formatTime, i18n, i18n$1, isAudioSrc, isDASHSrc, isHLSSrc, isMediaStream, isRemotionProvider, isRemotionSrc, isVideoSrc, menu_d_exports, plyrLayoutIcons, quality_slider_d_exports, radio_group_d_exports, slider_d_exports, speed_slider_d_exports, spinner_d_exports, thumbnail_d_exports, time_slider_d_exports, tooltip_d_exports, useActiveTextCues, useActiveTextTrack, useActiveThumbnail, useAudioGainOptions, useAudioOptions, useCaptionOptions, useChapterOptions, useChapterTitle, useDefaultLayoutContext, useDefaultLayoutWord, useMediaContext, useMediaPlayer, useMediaProvider, useMediaRemote, useMediaState, useMediaStore, usePlaybackRateOptions, usePlyrLayoutContext, usePlyrLayoutWord, useSliderPreview, useSliderState, useSliderStore, useState, useStore, useTextCues, useThumbnails, useVideoQualityOptions, volume_slider_d_exports };