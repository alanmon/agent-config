...
import { camelToKebabCase, composeRefs, effect, isArray, isBoolean, isKeyboardClick, isString, isUndefined, keysOf, listenEvent, onDispose, scoped, signal, toggleClass, uppercaseFirstChar, useContext, useSignal } from "../chunks/vidstack-CWZPUheZ.js";
import { Primitive, mediaContext, useMediaContext, useMediaState } from "../chunks/vidstack-DxAMdmBt.js";
import { IS_SERVER, getDownloadFile, isRemotionSrc, isTrackCaptionKind } from "../chunks/vidstack-WhhAuQBT.js";
import { Captions, ChapterTitle, Content, GoogleCastButton, Group, MediaAnnouncer, Root as Root$4, Root$1 as Root$2, Root$2 as Root$1, Root$3 as Root, Root$4 as Root$3, Title, Track, TrackFill, Trigger, createComputed, createEffect, createSignal, useActiveTextTrack, useChapterOptions, useChapterTitle, useScoped } from "../chunks/vidstack-CCOcVNkT.js";
import { AirPlayButton, Button, CaptionButton, ChapterTitle as ChapterTitle$1, Chapters, FullscreenButton, Gesture, Img, Item, Items, LiveButton, MuteButton, PIPButton, PlayButton, Portal, Preview, Progress, Root as Root$7, Root$1 as Root$5, Root$2 as Root$10, Root$3 as Root$6, Root$4 as Root$9, Root$5 as Root$8, SeekButton, Steps, Thumb, Thumbnail, Time, Track as Track$1, TrackFill as TrackFill$1, Value, appendParamsToURL, useAudioOptions, useCaptionOptions, useMediaContext as useMediaContext$1, useMediaPlayer, useVideoQualityOptions } from "../chunks/vidstack-CmGGM4tp.js";
import { RemotionSliderThumbnail, RemotionThumbnail } from "../chunks/vidstack-Bh7sFOCk.js";
import { useActive, useColorSchemePreference, useLayoutName, useResizeObserver, useTransitionActive } from "../chunks/vidstack-DnzY_njX.js";
import { defaultLayoutIcons } from "./vidstack-default-icons.js";
import * as React from "react";
import { flushSync } from "react-dom";
//#region src/components/layouts/default/context.ts
...
//#endregion
//#region src/components/layouts/default/hooks.ts
function useColorSchemeClass(colorScheme) {
	const systemColorPreference = useColorSchemePreference();
	if (colorScheme === "default") return null;
	else if (colorScheme === "system") return systemColorPreference;
	else return colorScheme;
}
//#endregion
//#region src/components/layouts/default/media-layout.tsx
function createDefaultMediaLayout({ type, smLayoutWhen, renderLayout }) {
	const Layout = React.forwardRef(({ children, className, disableTimeSlider = false, hideQualityBitrate = false, icons, colorScheme = "system", download = null, menuContainer = null, menuGroup = "bottom", noAudioGain = false, audioGains = {
		min: 0,
		max: 300,
		step: 25
		...
		const media = useMediaContext$1(), $load = useSignal(media.$props.load), $canLoad = useMediaState("canLoad"), $viewType = useMediaState("viewType"), $streamType = useMediaState("streamType"), $smallWhen = createComputed(() => {
		...
		}, canRender && isMatch ? /* @__PURE__ */ React.createElement(DefaultLayoutContext.Provider, { value: {
			disableTimeSlider,
			hideQualityBitrate,
			icons,
			colorScheme,
...
//#endregion
//#region src/components/layouts/default/slots.tsx
...
function slot(slots, name, defaultValue) {
	const slot = slots?.[name], capitalizedName = uppercaseFirstChar(name);
	return /* @__PURE__ */ React.createElement(React.Fragment, null, slots?.[`before${capitalizedName}`], isUndefined(slot) ? defaultValue : slot, slots?.[`after${capitalizedName}`]);
}
//#endregion
//#region src/components/layouts/default/ui/announcer.tsx
...
//#endregion
//#region src/components/layouts/default/ui/tooltip.tsx
function DefaultTooltip({ content, placement, children }) {
	const { showTooltipDelay } = useDefaultLayoutContext();
	return /* @__PURE__ */ React.createElement(Root, { showDelay: showTooltipDelay }, /* @__PURE__ */ React.createElement(Trigger, { asChild: true }, children), /* @__PURE__ */ React.createElement(Content, {
...
//#endregion
//#region src/components/layouts/default/ui/buttons.tsx
function DefaultPlayButton({ tooltip }) {
	...
	return /* @__PURE__ */ React.createElement(DefaultTooltip, {
		content: $paused ? playText : pauseText,
		placement: tooltip
	}, /* @__PURE__ */ React.createElement(PlayButton, {
		className: "vds-play-button vds-button",
		"aria-label": playText
	}, $ended ? /* @__PURE__ */ React.createElement(Icons.PlayButton.Replay, { className: "vds-icon" }) : $paused ? /* @__PURE__ */ React.createElement(Icons.PlayButton.Play, { className: "vds-icon" }) : /* @__PURE__ */ React.createElement(Icons.PlayButton.Pause, { className: "vds-icon" })));
}
...
const DefaultMuteButton = React.forwardRef(({ tooltip }, forwardRef) => {
	...
	return /* @__PURE__ */ React.createElement(DefaultTooltip, {
		...
		"aria-label": muteText,
		ref: forwardRef
	}, $muted || $volume == 0 ? /* @__PURE__ */ React.createElement(Icons.MuteButton.Mute, { className: "vds-icon" }) : $volume < .5 ? /* @__PURE__ */ React.createElement(Icons.MuteButton.VolumeLow, { className: "vds-icon" }) : /* @__PURE__ */ React.createElement(Icons.MuteButton.VolumeHigh, { className: "vds-icon" })));
});
...
function DefaultCaptionButton({ tooltip }) {
	...
	}, isOn ? /* @__PURE__ */ React.createElement(Icons.CaptionButton.On, { className: "vds-icon" }) : /* @__PURE__ */ React.createElement(Icons.CaptionButton.Off, { className: "vds-icon" })));
}
...
function DefaultPIPButton({ tooltip }) {
	...
	return /* @__PURE__ */ React.createElement(DefaultTooltip, {
		...
		placement: tooltip
	}, /* @__PURE__ */ React.createElement(PIPButton, {
		className: "vds-pip-button vds-button",
		"aria-label": pipText
	}, $pip ? /* @__PURE__ */ React.createElement(Icons.PIPButton.Exit, { className: "vds-icon" }) : /* @__PURE__ */ React.createElement(Icons.PIPButton.Enter, { className: "vds-icon" })));
}
...
function DefaultFullscreenButton({ tooltip }) {
	...
	}, $fullscreen ? /* @__PURE__ */ React.createElement(Icons.FullscreenButton.Exit, { className: "vds-icon" }) : /* @__PURE__ */ React.createElement(Icons.FullscreenButton.Enter, { className: "vds-icon" })));
}
...
function DefaultLiveButton() {
	...
	return $live ? /* @__PURE__ */ React.createElement(LiveButton, {
		className: "vds-live-button",
		"aria-label": label
	}, /* @__PURE__ */ React.createElement("span", { className: "vds-live-button-text" }, liveText)) : null;
}
DefaultLiveButton.displayName = "DefaultLiveButton";
function DefaultDownloadButton() {
	const { download, icons: Icons } = useDefaultLayoutContext(), $src = useMediaState("source"), file = getDownloadFile({
		title: useMediaState("title"),
		src: $src,
		download
	}), downloadText = useDefaultLayoutWord("Download");
	return isString(file?.url) ? /* @__PURE__ */ React.createElement(DefaultTooltip, {
		...
		download: file.name,
		target: "_blank"
	}, Icons.DownloadButton ? /* @__PURE__ */ React.createElement(Icons.DownloadButton.Default, { className: "vds-icon" }) : null)) : null;
}
DefaultDownloadButton.displayName = "DefaultDownloadButton";
//#endregion
//#region src/components/layouts/default/ui/captions.tsx
function DefaultCaptions() {
	const exampleText = useDefaultLayoutWord("Captions look like this");
	return /* @__PURE__ */ React.createElement(Captions, {
...
//#endregion
//#region src/components/layouts/default/ui/controls.tsx
...
//#endregion
//#region src/components/layouts/default/ui/menus/utils.ts
...
//#endregion
//#region src/components/layouts/default/ui/menus/chapters-menu.tsx
function DefaultChaptersMenu({ tooltip, placement, portalClass = "" }) {
	...
	const Content = /* @__PURE__ */ React.createElement(Items, {
		className: "vds-chapters-menu-items vds-menu-items",
		placement,
		offset: $offset
	}, isOpen ? /* @__PURE__ */ React.createElement(Root$5, {
		className: "vds-chapters-radio-group vds-radio-group",
		value: options.selectedValue,
		"data-thumbnails": thumbnails ? "" : null
	}, options.map(({ cue, label, value, startTimeText, durationText, select, setProgressVar }) => /* @__PURE__ */ React.createElement(Item, {
		className: "vds-chapter-radio vds-radio",
		value,
		key: value,
		onSelect: select,
		ref: setProgressVar
	}, thumbnails ? /* @__PURE__ */ React.createElement(Root$6, {
		src: thumbnails,
		className: "vds-thumbnail",
		time: cue.startTime
	}, /* @__PURE__ */ React.createElement(Img, null)) : $RemotionThumbnail && isRemotionSrc($src) ? /* @__PURE__ */ React.createElement($RemotionThumbnail, {
		className: "vds-thumbnail",
		frame: cue.startTime * $src.fps
	}) : null, /* @__PURE__ */ React.createElement("div", { className: "vds-chapter-radio-content" }, /* @__PURE__ */ React.createElement("span", { className: "vds-chapter-radio-label" }, label), /* @__PURE__ */ React.createElement("span", { className: "vds-chapter-radio-start-time" }, startTimeText), /* @__PURE__ */ React.createElement("span", { className: "vds-chapter-radio-duration" }, durationText))))) : null);
	...
	}, /* @__PURE__ */ React.createElement(Icons.Menu.Chapters, { className: "vds-icon" }))), noModal || !isSmallLayout ? Content : /* @__PURE__ */ React.createElement(Portal, {
...
//#endregion
//#region ../vidstack/src/core/font/font-options.ts
...
if (!IS_SERVER) for (const type of Object.keys(FONT_SIGNALS)) {
...
//#endregion
//#region ../vidstack/src/utils/color.ts
...
//#endregion
//#region ../vidstack/src/core/font/font-vars.ts
	...
	if (!isWatchingVars) {
		scoped(() => {
			for (const type of keysOf(FONT_SIGNALS)) {
				const $value = FONT_SIGNALS[type], defaultValue = FONT_DEFAULTS[type], storageKey = `vds-player:${camelToKebabCase(type)}`;
				effect(() => {
					const value = $value(), isDefaultVarValue = value === defaultValue;
					for (const player of players) setFontCssVar(player, type, value);
					if (isDefaultVarValue) localStorage.removeItem(storageKey);
...
function applyFontCssVars(player) {
	for (const type of keysOf(FONT_SIGNALS)) setFontCssVar(player, type, FONT_SIGNALS[type]());
}
function setFontCssVar(player, type, value) {
	const defaultValue = FONT_DEFAULTS[type], varName = `--media-user-${camelToKebabCase(type)}`, varValue = value !== defaultValue ? getCssVarValue(type, value) : null;
	if (type === "fontFamily") {
...
function getCssVarValue(type, value) {
	switch (type) {
		case "fontFamily": return getFontFamilyCSSVarValue(value);
		case "fontSize":
		case "textOpacity":
		case "textBgOpacity":
		case "displayBgOpacity": return percentToRatio(value);
		case "textColor": return `rgb(${hexToRgb(value)} / var(--media-user-text-opacity, 1))`;
		case "textShadow": return getTextShadowCssVarValue(value);
		case "textBg": return `rgb(${hexToRgb(value)} / var(--media-user-text-bg-opacity, 1))`;
		case "displayBg": return `rgb(${hexToRgb(value)} / var(--media-user-display-bg-opacity, 1))`;
	}
}
...
function getFontFamilyCSSVarValue(value) {
	switch (value) {
		case "mono-serif": return "\"Courier New\", Courier, \"Nimbus Mono L\", \"Cutive Mono\", monospace";
		case "mono-sans": return "\"Deja Vu Sans Mono\", \"Lucida Console\", Monaco, Consolas, \"PT Mono\", monospace";
		case "pro-sans": return "Roboto, \"Arial Unicode Ms\", Arial, Helvetica, Verdana, \"PT Sans Caption\", sans-serif";
		case "casual": return "\"Comic Sans MS\", Impact, Handlee, fantasy";
		case "cursive": return "\"Monotype Corsiva\", \"URW Chancery L\", \"Apple Chancery\", \"Dancing Script\", cursive";
		case "capitals": return "\"Arial Unicode Ms\", Arial, Helvetica, Verdana, \"Marcellus SC\", sans-serif + font-variant=small-caps";
		default: return "\"Times New Roman\", Times, Georgia, Cambria, \"PT Serif Caption\", serif";
	}
}
function getTextShadowCssVarValue(value) {
	switch (value) {
		case "drop shadow": return "rgb(34, 34, 34) 1.86389px 1.86389px 2.79583px, rgb(34, 34, 34) 1.86389px 1.86389px 3.72778px, rgb(34, 34, 34) 1.86389px 1.86389px 4.65972px";
		case "raised": return "rgb(34, 34, 34) 1px 1px, rgb(34, 34, 34) 2px 2px";
		case "depressed": return "rgb(204, 204, 204) 1px 1px, rgb(34, 34, 34) -1px -1px";
		case "outline": return "rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px";
		default: return "";
	}
}
//#endregion
//#region src/components/layouts/default/ui/menus/items/menu-items.tsx
function DefaultMenuSection({ label, value, children }) {
	const id = React.useId();
	if (!label) return /* @__PURE__ */ React.createElement("div", { className: "vds-menu-section" }, /* @__PURE__ */ React.createElement("div", { className: "vds-menu-section-body" }, children));
	return /* @__PURE__ */ React.createElement("section", {
		className: "vds-menu-section",
		role: "group",
		"aria-labelledby": id
	}, /* @__PURE__ */ React.createElement("div", { className: "vds-menu-section-title" }, /* @__PURE__ */ React.createElement("header", { id }, label), value ? /* @__PURE__ */ React.createElement("div", { className: "vds-menu-section-value" }, value) : null), /* @__PURE__ */ React.createElement("div", { className: "vds-menu-section-body" }, children));
}
...
function DefaultMenuRadioGroup({ value, options, onChange }) {
	...
	return /* @__PURE__ */ React.createElement(Root$5, {
		...
		value,
		onChange
	}, options.map((option) => /* @__PURE__ */ React.createElement(Item, {
		className: "vds-radio",
		value: option.value,
		key: option.value
	}, /* @__PURE__ */ React.createElement(Icons.Menu.RadioCheck, { className: "vds-icon" }), /* @__PURE__ */ React.createElement("span", {
...
function createRadioOptions(entries) {
	return React.useMemo(() => isArray(entries) ? entries.map((entry) => ({
		label: entry,
...
//#endregion
//#region src/components/layouts/default/ui/menus/items/menu-slider.tsx
...
function DefaultSliderParts() {
	return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Track$1, { className: "vds-slider-track" }), /* @__PURE__ */ React.createElement(TrackFill$1, { className: "vds-slider-track-fill vds-slider-track" }), /* @__PURE__ */ React.createElement(Thumb, { className: "vds-slider-thumb" }));
}
DefaultSliderParts.displayName = "DefaultSliderParts";
function DefaultSliderSteps() {
	return /* @__PURE__ */ React.createElement(Steps, { className: "vds-slider-steps" }, (step) => /* @__PURE__ */ React.createElement("div", {
...
//#endregion
//#region src/components/layouts/default/ui/menus/font-menu.tsx
...
function DefaultFontSetting({ label, option, type }) {
	...
	if (option.type === "color") {
		...
		return /* @__PURE__ */ React.createElement(DefaultMenuItem, { label: translatedLabel }, /* @__PURE__ */ React.createElement("input", {
	...
	if (option.type === "slider") {
		...
		return /* @__PURE__ */ React.createElement(DefaultMenuSliderItem, {
			...
			isMin: $value === min + "%",
			isMax: $value === max + "%"
		}, /* @__PURE__ */ React.createElement(Root$8, {
		...
		}, /* @__PURE__ */ React.createElement(DefaultSliderParts, null), /* @__PURE__ */ React.createElement(DefaultSliderSteps, null)));
	}
	if (option.type === "radio") return /* @__PURE__ */ React.createElement(DefaultFontRadioGroup, {
...
function DefaultFontRadioGroup({ id, label, value, values, onChange }) {
	...
	return /* @__PURE__ */ React.createElement(Root$7, { className: `vds-${id}-menu vds-menu` }, /* @__PURE__ */ React.createElement(DefaultMenuButton, {
		label,
		hint
	}), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, /* @__PURE__ */ React.createElement(DefaultMenuRadioGroup, {
		value,
...
function DefaultResetMenuItem() {
	...
	return /* @__PURE__ */ React.createElement("button", {
		...
		role: "menuitem",
		onClick: onFontReset
	}, /* @__PURE__ */ React.createElement("span", { className: "vds-menu-item-label" }, resetText));
}
DefaultResetMenuItem.displayName = "DefaultResetMenuItem";
//#endregion
//#region src/components/layouts/default/ui/menus/items/menu-checkbox.tsx
function DefaultMenuCheckbox({ label, checked, storageKey, defaultChecked = false, onChange }) {
	...
	React.useEffect(() => {
		const checked = !!((storageKey ? localStorage.getItem(storageKey) : null) ?? defaultChecked);
...
//#endregion
//#region src/components/layouts/default/ui/menus/accessibility-menu.tsx
function DefaultAccessibilityMenu({ slots }) {
	...
	return /* @__PURE__ */ React.createElement(Root$7, { className: "vds-accessibility-menu vds-menu" }, /* @__PURE__ */ React.createElement(DefaultMenuButton, {
		label,
		Icon: Icons.Menu.Accessibility
	}), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, slot(slots, "accessibilityMenuItemsStart", null), /* @__PURE__ */ React.createElement(DefaultMenuSection, null, /* @__PURE__ */ React.createElement(DefaultAnnouncementsMenuCheckbox, null), /* @__PURE__ */ React.createElement(DefaultKeyboardAnimationsMenuCheckbox, null)), /* @__PURE__ */ React.createElement(DefaultMenuSection, null, /* @__PURE__ */ React.createElement(DefaultFontMenu, null)), slot(slots, "accessibilityMenuItemsEnd", null)));
}
...
function DefaultAnnouncementsMenuCheckbox() {
	...
	return /* @__PURE__ */ React.createElement(DefaultMenuItem, { label }, /* @__PURE__ */ React.createElement(DefaultMenuCheckbox, {
		label,
		defaultChecked: true,
...
//#endregion
//#region src/components/layouts/default/ui/menus/audio-menu.tsx
function DefaultAudioMenu({ slots }) {
	...
	return /* @__PURE__ */ React.createElement(Root$7, { className: "vds-audio-menu vds-menu" }, /* @__PURE__ */ React.createElement(DefaultMenuButton, {
		label,
		hint: $audioTrack?.label,
		Icon: Icons.Menu.Audio
	}), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, slot(slots, "audioMenuItemsStart", null), /* @__PURE__ */ React.createElement(DefaultAudioTracksMenu, null), hasGainSlider ? /* @__PURE__ */ React.createElement(DefaultAudioBoostMenuSection, null) : null, slot(slots, "audioMenuItemsEnd", null)));
}
...
function DefaultAudioBoostMenuSection() {
	...
	if ($disabled) return null;
	return /* @__PURE__ */ React.createElement(DefaultMenuSection, {
		label,
		value
	}, /* @__PURE__ */ React.createElement(DefaultMenuSliderItem, {
...
function useGainMin() {
	...
	return (isArray(audioGains) ? audioGains[0] : audioGains?.min) ?? 0;
}
function useGainMax() {
	const { audioGains } = useDefaultLayoutContext();
	return (isArray(audioGains) ? audioGains[audioGains.length - 1] : audioGains?.max) ?? 300;
}
function useGainStep() {
	const { audioGains } = useDefaultLayoutContext();
	return (isArray(audioGains) ? audioGains[1] - audioGains[0] : audioGains?.step) || 25;
}
...
function DefaultAudioTracksMenu() {
	...
	return /* @__PURE__ */ React.createElement(Root$7, { className: "vds-audio-track-menu vds-menu" }, /* @__PURE__ */ React.createElement(DefaultMenuButton, {
		label,
		hint: $track?.label ?? defaultText,
		disabled: options.disabled,
		Icon: Icons.Menu.Audio
	}), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, /* @__PURE__ */ React.createElement(Root$5, {
		className: "vds-audio-radio-group vds-radio-group",
		value: options.selectedValue
	}, options.map(({ label, value, select }) => /* @__PURE__ */ React.createElement(Item, {
		className: "vds-audio-radio vds-radio",
		value,
		onSelect: select,
		key: value
	}, /* @__PURE__ */ React.createElement(Icons.Menu.RadioCheck, { className: "vds-icon" }), /* @__PURE__ */ React.createElement("span", { className: "vds-radio-label" }, label))))));
}
DefaultAudioTracksMenu.displayName = "DefaultAudioTracksMenu";
//#endregion
//#region src/components/layouts/default/ui/menus/captions-menu.tsx
function DefaultCaptionMenu({ slots }) {
	...
	if (options.disabled) return null;
	return /* @__PURE__ */ React.createElement(Root$7, { className: "vds-captions-menu vds-menu" }, /* @__PURE__ */ React.createElement(DefaultMenuButton, {
		label,
		hint,
		disabled: options.disabled,
		Icon: Icons.Menu.Captions
	}), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, slot(slots, "captionsMenuItemsStart", null), /* @__PURE__ */ React.createElement(Root$5, {
		...
		onSelect: select,
		key: value
	}, /* @__PURE__ */ React.createElement(Icons.Menu.RadioCheck, { className: "vds-icon" }), /* @__PURE__ */ React.createElement("span", { className: "vds-radio-label" }, label)))), slot(slots, "captionsMenuItemsEnd", null)));
}
DefaultCaptionMenu.displayName = "DefaultCaptionMenu";
//#endregion
//#region src/components/layouts/default/ui/menus/quality-menu.tsx
function DefaultQualityMenu({ slots }) {
	...
	return /* @__PURE__ */ React.createElement(Root$7, { className: "vds-quality-menu vds-menu" }, /* @__PURE__ */ React.createElement(DefaultMenuButton, {
		label,
		Icon: Icons.Menu.QualityUp
	}), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, slot(slots, "qualityMenuItemsStart", null), /* @__PURE__ */ React.createElement(Root$5, {
		className: "vds-quality-radio-group vds-radio-group",
		value: options.selectedValue
	}, options.map(({ label, value, bitrateText, select }) => /* @__PURE__ */ React.createElement(Item, {
		className: "vds-quality-radio vds-radio",
		value,
		onSelect: select,
		key: value
	}, /* @__PURE__ */ React.createElement(Icons.Menu.RadioCheck, { className: "vds-icon" }), /* @__PURE__ */ React.createElement("span", { className: "vds-radio-label" }, label), !hideQualityBitrate && bitrateText ? /* @__PURE__ */ React.createElement("span", { className: "vds-radio-hint" }, bitrateText) : null))), slot(slots, "qualityMenuItemsEnd", null)));
}
DefaultQualityMenu.displayName = "DefaultQualityMenu";
//#endregion
//#region src/components/layouts/default/ui/menus/speed-menu.tsx
function DefaultSpeedMenu({ slots }) {
	...
	return /* @__PURE__ */ React.createElement(Root$7, { className: "vds-speed-menu vds-menu" }, /* @__PURE__ */ React.createElement(DefaultMenuButton, {
		label,
		hint: value,
		Icon: Icons.Menu.SpeedUp
	}), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, slot(slots, "speedMenuItemsStart", null), /* @__PURE__ */ React.createElement(DefaultMenuSection, {
		label,
		value
	}, /* @__PURE__ */ React.createElement(DefaultMenuSliderItem, {
		UpIcon: Icons.Menu.FontSizeUp,
	...
	}, /* @__PURE__ */ React.createElement(Root$2, {
		...
		step,
		keyStep: step
	}, /* @__PURE__ */ React.createElement(DefaultSliderParts, null), /* @__PURE__ */ React.createElement(DefaultSliderSteps, null)))), slot(slots, "speedMenuItemsEnd", null)));
}
...
function useSpeedStep() {
	const { playbackRates } = useDefaultLayoutContext(), rates = playbackRates;
	return (isArray(rates) ? rates[1] - rates[0] : rates?.step) || .25;
}
//#endregion
//#region src/components/layouts/default/ui/menus/settings-menu.tsx
function DefaultSettingsMenu({ tooltip, placement, portalClass = "", slots }) {
	...
	const Content = /* @__PURE__ */ React.createElement(Items, {
		...
		placement,
		offset: $offset
	}, isOpen ? /* @__PURE__ */ React.createElement(React.Fragment, null, slot(slots, "settingsMenuItemsStart", null), slot(slots, "settingsMenuStartItems", null), /* @__PURE__ */ React.createElement(DefaultSpeedMenu, { slots }), /* @__PURE__ */ React.createElement(DefaultQualityMenu, { slots }), /* @__PURE__ */ React.createElement(DefaultAccessibilityMenu, { slots }), /* @__PURE__ */ React.createElement(DefaultAudioMenu, { slots }), /* @__PURE__ */ React.createElement(DefaultCaptionMenu, { slots }), slot(slots, "settingsMenuEndItems", null), slot(slots, "settingsMenuItemsEnd", null)) : null);
	return /* @__PURE__ */ React.createElement(Root$7, {
	...
	}, /* @__PURE__ */ React.createElement(Icons.Menu.Settings, { className: "vds-icon vds-rotate-icon" }))), noModal || !isSmallLayout ? Content : /* @__PURE__ */ React.createElement(Portal, {
		className: portalClass + (colorSchemeClass ? ` ${colorSchemeClass}` : ""),
		container: menuContainer ?? dialogEl,
		disabled: "fullscreen",
		"data-sm": isSmallLayout ? "" : null,
...
//#endregion
//#region src/components/layouts/default/ui/sliders.tsx
function DefaultVolumePopup({ tooltip, orientation, slots }) {
	...
	return $pointer === "coarse" && !$muted ? null : /* @__PURE__ */ React.createElement("div", {
		className: "vds-volume",
		"data-active": isRootActive ? "" : null,
		ref: setRootEl
	}, muteButton, /* @__PURE__ */ React.createElement("div", { className: "vds-volume-popup" }, slot(slots, "volumeSlider", /* @__PURE__ */ React.createElement(DefaultVolumeSlider, { orientation }))));
}
...
function DefaultVolumeSlider(props) {
	...
	return /* @__PURE__ */ React.createElement(Root$9, {
		...
		"aria-label": label,
		...props
	}, /* @__PURE__ */ React.createElement(Track$1, { className: "vds-slider-track" }), /* @__PURE__ */ React.createElement(TrackFill$1, { className: "vds-slider-track-fill vds-slider-track" }), /* @__PURE__ */ React.createElement(Thumb, { className: "vds-slider-thumb" }), /* @__PURE__ */ React.createElement(Preview, {
		className: "vds-slider-preview",
		noClamp: true
	}, /* @__PURE__ */ React.createElement(Value, { className: "vds-slider-value" })));
}
...
function DefaultTimeSlider() {
	...
	return /* @__PURE__ */ React.createElement(Root$10, {
		...
		keyStep: seekStep,
		ref: setInstance
	}, /* @__PURE__ */ React.createElement(Chapters, {
		className: "vds-slider-chapters",
		disabled: width < sliderChaptersMinWidth
	}, (cues, forwardRef) => cues.map((cue) => /* @__PURE__ */ React.createElement("div", {
		className: "vds-slider-chapter",
		key: cue.startTime,
		ref: forwardRef
	}, /* @__PURE__ */ React.createElement(Track$1, { className: "vds-slider-track" }), /* @__PURE__ */ React.createElement(TrackFill$1, { className: "vds-slider-track-fill vds-slider-track" }), /* @__PURE__ */ React.createElement(Progress, { className: "vds-slider-progress vds-slider-track" })))), /* @__PURE__ */ React.createElement(Thumb, { className: "vds-slider-thumb" }), /* @__PURE__ */ React.createElement(Preview, { className: "vds-slider-preview" }, thumbnails ? /* @__PURE__ */ React.createElement(Thumbnail.Root, {
		src: thumbnails,
		className: "vds-slider-thumbnail vds-thumbnail"
	}, /* @__PURE__ */ React.createElement(Thumbnail.Img, null)) : $RemotionSliderThumbnail && isRemotionSrc($src) ? /* @__PURE__ */ React.createElement($RemotionSliderThumbnail, { className: "vds-slider-thumbnail vds-thumbnail" }) : null, /* @__PURE__ */ React.createElement(ChapterTitle$1, { className: "vds-slider-chapter-title" }), /* @__PURE__ */ React.createElement(Value, { className: "vds-slider-value" })));
}
DefaultTimeSlider.displayName = "DefaultTimeSlider";
//#endregion
//#region src/components/layouts/default/ui/time.tsx
function DefaultTimeGroup({ slots }) {
	if (!useMediaState("duration")) return null;
	return /* @__PURE__ */ React.createElement("div", { className: "vds-time-group" }, slot(slots, "currentTime", /* @__PURE__ */ React.createElement(Time, {
		className: "vds-time",
		type: "current"
	})), slot(slots, "timeDivider", /* @__PURE__ */ React.createElement("div", { className: "vds-time-divider" }, "/")), slot(slots, "endTime", /* @__PURE__ */ React.createElement(Time, {
		className: "vds-time",
		type: "duration"
	})));
}
...
function DefaultTimeInfo({ slots }) {
	return useMediaState("live") ? slot(slots, "liveButton", /* @__PURE__ */ React.createElement(DefaultLiveButton, null)) : /* @__PURE__ */ React.createElement(DefaultTimeGroup, { slots });
}
...
function DefaultTimeInvert({ slots }) {
	...
	return $live ? slot(slots, "liveButton", /* @__PURE__ */ React.createElement(DefaultLiveButton, null)) : slot(slots, "endTime", $duration ? /* @__PURE__ */ React.createElement(Time, {
		className: "vds-time",
		type: "current",
		toggle: true,
		remainder: true
...
//#endregion
//#region src/components/layouts/default/audio-layout.tsx
...
function DefaultAudioLayout(props) {
	...
	return /* @__PURE__ */ React.createElement(MediaLayout$1, {
		...props,
...
function AudioLayout() {
	...
	useLayoutName("audio");
	return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(DefaultAnnouncer, null), /* @__PURE__ */ React.createElement(DefaultCaptions, null), /* @__PURE__ */ React.createElement(Root$3, { className: "vds-controls" }, /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "seekBackwardButton", /* @__PURE__ */ React.createElement(DefaultSeekButton, {
		backward: true,
		tooltip: "top start"
	})), slot(slots, "playButton", /* @__PURE__ */ React.createElement(DefaultPlayButton, { tooltip: "top center" })), slot(slots, "seekForwardButton", /* @__PURE__ */ React.createElement(DefaultSeekButton, { tooltip: "top center" })), /* @__PURE__ */ React.createElement(DefaultAudioTitle, null), slot(slots, "timeSlider", /* @__PURE__ */ React.createElement(DefaultTimeSlider, null)), /* @__PURE__ */ React.createElement(DefaultTimeInvert, { slots }), /* @__PURE__ */ React.createElement(DefaultVolumePopup, {
		orientation: "vertical",
		tooltip: "top",
		slots
	}), slot(slots, "captionButton", /* @__PURE__ */ React.createElement(DefaultCaptionButton, { tooltip: "top center" })), slot(slots, "downloadButton", /* @__PURE__ */ React.createElement(DefaultDownloadButton, null)), /* @__PURE__ */ React.createElement(DefaultAudioMenus, { slots }))));
}
...
function DefaultAudioMenus({ slots }) {
	...
	return /* @__PURE__ */ React.createElement(React.Fragment, null, slot(slots, "chaptersMenu", /* @__PURE__ */ React.createElement(DefaultChaptersMenu, {
		tooltip: "top",
		placement,
		portalClass: "vds-audio-layout"
	})), slot(slots, "settingsMenu", /* @__PURE__ */ React.createElement(DefaultSettingsMenu, {
		tooltip: "top end",
		placement,
		portalClass: "vds-audio-layout",
		slots
...
function DefaultAudioTitle() {
	const [rootEl, setRootEl] = React.useState(null), media = useMediaContext$1(), { translations } = useDefaultLayoutContext(), [isTextOverflowing, setIsTextOverflowing] = React.useState(false);
	const isContinued = createComputed(() => {
		const { started, currentTime } = media.$state;
		return started() || currentTime() > 0;
	});
	const $title = useSignal(createComputed(() => {
	...
	useResizeObserver(rootEl, React.useCallback(() => {
	...
	return $title ? /* @__PURE__ */ React.createElement("span", {
		...
		title: $title,
		ref: setRootEl
	}, /* @__PURE__ */ React.createElement(AudioTitle, {
		title: $title,
		chapterTitle: $chapterTitle
	}), isTextOverflowing && !isTransitionActive ? /* @__PURE__ */ React.createElement(AudioTitle, {
		title: $title,
		chapterTitle: $chapterTitle
	}) : null) : /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null);
}
...
//#endregion
//#region src/components/layouts/default/ui/keyboard-display.tsx
const DefaultKeyboardDisplay = React.forwardRef(({ icons: Icons, ...props }, forwardRef) => {
	...
	const className = React.useMemo(() => `vds-kb-action${!visible ? " hidden" : ""}${props.className ? ` ${props.className}` : ""}`, [visible]);
	...
	return Icon ? /* @__PURE__ */ React.createElement(Primitive.div, {
		...props,
		className,
		"data-action": actionDataAttr,
		ref: forwardRef
	}, /* @__PURE__ */ React.createElement("div", { className: "vds-kb-text-wrapper" }, /* @__PURE__ */ React.createElement("div", { className: "vds-kb-text" }, $text)), /* @__PURE__ */ React.createElement("div", {
		className: "vds-kb-bezel",
		key: count
	}, /* @__PURE__ */ React.createElement("div", { className: "vds-kb-icon" }, /* @__PURE__ */ React.createElement(Icon, null)))) : null;
});
...
function getText() {
	...
	switch (action) {
		case "toggleMuted": return $state.muted() ? "0%" : getVolumeText($state.volume(), audioGain);
		case "volumeUp":
		case "volumeDown": return getVolumeText($state.volume(), audioGain);
		default: return "";
	}
}
...
function getIcon(Icons) {
	...
	switch ($state.lastKeyboardAction()?.action) {
		case "togglePaused": return !$state.paused() ? Icons.Play : Icons.Pause;
		case "toggleMuted": return $state.muted() || $state.volume() === 0 ? Icons.Mute : $state.volume() >= .5 ? Icons.VolumeUp : Icons.VolumeDown;
		case "toggleFullscreen": return $state.fullscreen() ? Icons.EnterFullscreen : Icons.ExitFullscreen;
		case "togglePictureInPicture": return $state.pictureInPicture() ? Icons.EnterPiP : Icons.ExitPiP;
		case "toggleCaptions": return $state.hasCaptions() ? $state.textTrack() ? Icons.CaptionsOn : Icons.CaptionsOff : null;
		case "volumeUp": return Icons.VolumeUp;
		case "volumeDown": return Icons.VolumeDown;
		case "seekForward": return Icons.SeekForward;
		case "seekBackward": return Icons.SeekBackward;
		default: return null;
	}
}
//#endregion
//#region src/components/layouts/default/ui/title.tsx
function DefaultTitle() {
	const $started = useMediaState("started"), $title = useMediaState("title");
	return useActiveTextTrack("chapters") && ($started || !$title) ? /* @__PURE__ */ React.createElement(ChapterTitle, { className: "vds-chapter-title" }) : /* @__PURE__ */ React.createElement(Title, { className: "vds-chapter-title" });
}
DefaultTitle.displayName = "DefaultTitle";
//#endregion
//#region src/components/layouts/default/video-layout.tsx
...
function DefaultVideoSmallLayout() {
	...
	return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(DefaultAnnouncer, null), /* @__PURE__ */ React.createElement(DefaultVideoGestures, null), /* @__PURE__ */ React.createElement(DefaultVideoKeyboardDisplay, null), slot(slots, "bufferingIndicator", /* @__PURE__ */ React.createElement(DefaultBufferingIndicator, null)), slot(slots, "captions", /* @__PURE__ */ React.createElement(DefaultCaptions, null)), /* @__PURE__ */ React.createElement(Root$3, { className: "vds-controls" }, /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "topControlsGroupStart", null), slot(slots, "airPlayButton", /* @__PURE__ */ React.createElement(DefaultAirPlayButton, { tooltip: "top start" })), slot(slots, "googleCastButton", /* @__PURE__ */ React.createElement(DefaultGoogleCastButton, { tooltip: "top start" })), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), slot(slots, "topControlsGroupCenter", null), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), slot(slots, "captionButton", /* @__PURE__ */ React.createElement(DefaultCaptionButton, { tooltip: "bottom" })), slot(slots, "downloadButton", /* @__PURE__ */ React.createElement(DefaultDownloadButton, null)), /* @__PURE__ */ React.createElement(DefaultVideoMenus, { slots }), /* @__PURE__ */ React.createElement(DefaultVolumePopup, {
		orientation: "vertical",
		tooltip: "bottom end",
		slots
	}), slot(slots, "topControlsGroupEnd", null)), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), /* @__PURE__ */ React.createElement(Group, {
		className: "vds-controls-group",
		style: { pointerEvents: "none" }
	}, slot(slots, "centerControlsGroupStart", null), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), slot(slots, "centerControlsGroupCenter", null), slot(slots, "playButton", /* @__PURE__ */ React.createElement(DefaultPlayButton, { tooltip: "top" })), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), slot(slots, "centerControlsGroupEnd", null)), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, /* @__PURE__ */ React.createElement(DefaultTimeInfo, { slots }), slot(slots, "chapterTitle", /* @__PURE__ */ React.createElement(DefaultTitle, null)), slot(slots, "fullscreenButton", /* @__PURE__ */ React.createElement(DefaultFullscreenButton, { tooltip: "top end" }))), /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "timeSlider", /* @__PURE__ */ React.createElement(DefaultTimeSlider, null)))), slot(slots, "startDuration", /* @__PURE__ */ React.createElement(DefaultVideoStartDuration, null)));
}
...
function DefaultVideoStartDuration() {
	...
	return /* @__PURE__ */ React.createElement("div", { className: "vds-start-duration" }, /* @__PURE__ */ React.createElement(Time, {
		className: "vds-time",
		type: "duration"
	}));
}
...
function DefaultVideoGestures() {
	...
	return /* @__PURE__ */ React.createElement("div", { className: "vds-gestures" }, /* @__PURE__ */ React.createElement(Gesture, {
		className: "vds-gesture",
		event: "pointerup",
		action: "toggle:paused"
	}), /* @__PURE__ */ React.createElement(Gesture, {
		className: "vds-gesture",
		event: "pointerup",
...
function DefaultBufferingIndicator() {
	return /* @__PURE__ */ React.createElement("div", { className: "vds-buffering-indicator" }, /* @__PURE__ */ React.createElement(Root$4, { className: "vds-buffering-spinner" }, /* @__PURE__ */ React.createElement(Track, { className: "vds-buffering-track" }), /* @__PURE__ */ React.createElement(TrackFill, { className: "vds-buffering-track-fill" })));
}
...
//#endregion
export { DefaultAudioLayout, DefaultBufferingIndicator, DefaultKeyboardDisplay, DefaultKeyboardDisplay as DefaultKeyboardDisplay$1, DefaultLayoutContext, DefaultMenuButton, DefaultMenuCheckbox, DefaultMenuItem, DefaultMenuRadioGroup, DefaultMenuSection, DefaultMenuSliderItem, DefaultSliderParts, DefaultSliderSteps, DefaultTooltip, DefaultVideoGestures, DefaultVideoLargeLayout, DefaultVideoLayout, DefaultVideoSmallLayout, createRadioOptions, defaultLayoutIcons, i18n, useDefaultLayoutContext, useDefaultLayoutWord };
